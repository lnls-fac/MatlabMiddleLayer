function [eff, r_scrn, r_end, machine, r_bpm, int_bpm] = bo_pulses(machine, param, n_part, n_pulse, point, kckr, plt, diag)
...
r_scrn = compares_vchamb(machine, r_scrn, point, 'screen');
