function [bba_data1, bba_data2] = bba_loop(machine, n_mach, param, param_errors, n_part, n_pulse, M_acc, n_points, plane, data_bpm)
    ...
    bba_data1 = sirius_commis.first_turns.bo.bba_non_stored_beam(machine, n_mach, param, param_errors, n_part, n_pulse, M_acc, n_points, plane, data_bpm);
    ...
    bba_data2 = sirius_commis.first_turns.bo.bba_non_stored_beam(machine, n_mach, param, param_errors, n_part, n_pulse, M_acc, n_points, plane, data_bpm, data_input1);
