...
% sirius_commis.common.initializations();
    ...
    for j = 1:n_mach
        ...
        for i = 1:n_pulse
            ...
            if i == 1
                r{j} = sirius_commis.first_turns.bo.single_pulse_turn(machine, param, param_errors, n_part, n_turns, n_turns);
                ...
                r{j} = sirius_commis.first_turns.bo.single_pulse_turn(machine, param, param_errors, n_part, n_turns, count_turns(i-1, :));
                count_turns(i, j) = r{j}.num_of_turns;
