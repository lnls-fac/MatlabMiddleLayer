function [machine_cell, hund_turns, count_turns, num_sv] = orbit_correction(machine, n_mach, param, param_errors, respm, n_sv, n_part, n_pulse, several_turns)
...
%   machine{cavity_ind}.PhaseLag = 2.28479465715621;
    ...
    for j = 1:n_mach
        ...
        [count_turns{j}, r_bpm, int_bpm, ~, ~, fm_old] = sirius_commis.first_turns.si.multiple_pulse_turn(machine, 1, param, param_errors, n_part, n_pulse, several_turns);
...
%             drawnow();
            ...
            [count_turns{j}, r_bpm, int_bpm, ~, ~, fm_new] = sirius_commis.first_turns.si.multiple_pulse_turn(machine_n, 1, param, param_errors, n_part, n_pulse, turn_inc*several_turns);
            min_turns_0 = min(count_turns{j});
