...
% Version 1 - Murilo B. Alves, 2018
    ...
    param_errors.xl_error_sist = 3e-3; 
    ...
    param_errors.y_error_sist = 0; % 1e-3; 
    param.offset_y_sist = param.offset_y0 + param_errors.y_error_sist;
    param_errors.y_error_pulse = 0; % 10e-6; 
    
    param_errors.yl_error_sist = 0; % 1e-3; 
    param.offset_yl_sist = param.offset_yl0 + param_errors.yl_error_sist;
    param_errors.yl_error_pulse = 0; % 1e-6; 
    ...
    param_errors.delta_error_sist = 1e-2; 
    param.delta_sist = param.delta0 + param_errors.delta_error_sist;
    param_errors.delta_error_pulse = 0.1e-2;
    
    param_errors.sigma_bpm = 2e-3; % Single pass = 2mm, Turn-by-turn = 3mm
    param_errors.offsets_bpm = 0.1e-3;
    param_errors.cutoff = 1;
    % param_errors.offsets_bpm_bba = lnls_generate_random_numbers(1, length(param.etax_bpms), 'norm', param_errors.cutoff) .* param_errors.offsets_bpm;
