...
% Version 1 - Murilo B. Alves, 2018
    ...
    param_errors.x_error_sist = f * 1e-3 * lnls_generate_random_numbers(1, 1, 'norm', cutoff);
    param.offset_x_sist = param.offset_x0 + param_errors.x_error_sist;
    param_errors.x_error_pulse = 0.5e-3;
    
    param_errors.xl_error_sist = f * 1e-3 * lnls_generate_random_numbers(1, 1, 'norm', cutoff); 
    ...
    param_errors.y_error_sist = f * 1e-3 * lnls_generate_random_numbers(1, 1, 'norm', cutoff);
    param.offset_y_sist = param.offset_y0 + param_errors.y_error_sist;
    param_errors.y_error_pulse = 0.5e-3;
    
    param_errors.yl_error_sist = f * 1e-3 * lnls_generate_random_numbers(1, 1, 'norm', cutoff); 
    ...
    param_errors.kckr_error_sist = f * 1e-3 * lnls_generate_random_numbers(1, 1, 'norm', cutoff); 
    ...
    param_errors.delta_error_sist = 0 * 1e-2 * lnls_generate_random_numbers(1, 1, 'norm', cutoff); 
    ...
    param.yl_sept_init = param.offset_yl_sist;
    param.x_sept_init = param.offset_x_sist;
    param.y_sept_init = param.offset_y_sist;
end
