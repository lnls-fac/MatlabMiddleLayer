function lnls_plot_vertical_vchamber(the_ring, smin, smax, y, dy, handle_cf)
...
hmax = [getcellstruct(the_ring, 'VChamber', 1:length(the_ring), 1, 2); the_ring{end}.VChamber(2)]';
