%   [W,Wm] = LNLS_TAU_ELASTICO_INVERSO(Z,T,cp,R,EA_x,EA_y,r,P,Bx,By)
%   calcula 1/tau, onde tau é o tempo de vida elástico, em segundos. W é um
%   vetor contendo os valores de tempo de vida ao longo do vetor posição r,
...
function [W,Wm] = lnls_tau_elastico_inverso(Z,T,cp,R,EA_x,EA_y,r,P,Bx,By)
