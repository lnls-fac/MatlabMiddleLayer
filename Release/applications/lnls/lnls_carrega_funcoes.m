...
function [r,Pr,Bx,By,alphax,alphay,etax,etaxl,etay,etayl,err] = lnls_carrega_funcoes(s_B,Bx0,By0,alphax0,alphay0,etax0,etay0,etaxl0,etayl0,pres,flag_refine)
...
if(flag_interp)
    ...
    Pr = interp1(s_P,P,r,'linear','extrap');
    %P = 1.333e-9*ones(length(s_B),1);
