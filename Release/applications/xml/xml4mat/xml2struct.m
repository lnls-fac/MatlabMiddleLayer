function [y,varname]=xml2struct(filename_or_xml_string,plt)

%XML2STRUCT reads non-MbML compliant xmlfile into matlab structure
%
% Syntax: [y,varname]=xml2struct(filename_or_xml_string,plt)
%
% Description:
...
[y,varname]=xml2cell(filename_or_xml_string,plt);
y=consolidateall(y);