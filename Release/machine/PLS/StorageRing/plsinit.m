...
val =cor{ii,12};    AO.HCM.Setpoint.Tolerance(ii,1)    = Inf;
                    AO.VCM.Setpoint.Tolerance(ii,1)    = 0.5;
...
name=q1{ii,3};      AO.Q1.Monitor.ChannelNames(ii,:)  = name;
name=q1{ii,4};      AO.Q1.Setpoint.ChannelNames(ii,:) = name;     
...
name=q2{ii,3};      AO.Q2.Monitor.ChannelNames(ii,:)  = name;
name=q2{ii,4};      AO.Q2.Setpoint.ChannelNames(ii,:) = name;     
