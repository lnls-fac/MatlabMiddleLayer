...
% S12DI Template %
e01 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), (2*pi/12)/2, 0, -0.098122104639, 0.032, 0.6512, 0.6512, 'BendLinearPass');
e02 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e03 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e04 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e05 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e06 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e07 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e08 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e09 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e10 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e11 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e12 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e13 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e14 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e15 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e16 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e17 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e18 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e19 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, 0, -0.098122104639, 0.032, 0, 0, 'BendLinearPass');
e20 = rbend2('BEND', (0.54253/20),  (2*pi/(12*20)), 0, (2*pi/12)/2, -0.098122104639, 0.032, 0.6512, 0.6512, 'BendLinearPass');
S12DI_element = [e01 e02 e03 e04 e05 e06 e07 e08 e09 e10 e11 e12 e13 e14 e15 e16 e17 e18 e19 e20];
