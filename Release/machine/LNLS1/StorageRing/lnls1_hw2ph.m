function k = lnls1_hw2ph(Family, Field, Amps, DeviceList, Energy)
%LNLS1_HW2PH - Converts hardware (amperes) to simulator values
%
...
if any(strcmpi(Field, {'Setpoint','Monitor'}))
    ...
    elseif any(strcmpi(Family, findmemberof('AWG01','AON11')))
        [bfield, tout, DataTime, ErrorFlag] = lnls1_gap2field(Family, Field, Amps, DeviceList);
        k = bfield;
