...
TR01 = [TR01_1 AQD01A TR01_2 ACV01A TR01_3 SK7 AQF01A TR01_4 AMP01A TR01_5 ACH01A TR01_6 AWI01 TR01_7 ACH01B TR01_8 AMP01B TR01_9 AQF01B TR01_10 ACV01B TR01_11 AQD01B TR01_12 ];
...
TR03_13 = drift('ATR', 0.508282, 'DriftPass');
AMP03C = BPM_element;
...
ACH11A = ACH_element;
TR11_6 = drift('ATR', 0.1275, 'DriftPass');
AQS11 = SKEWCORR_element;
TR11_7 = drift('ATR', 0.25992, 'DriftPass');
AMU11A = BPM_element;
TR11_8 = drift('ATR', 0.26628, 'DriftPass');
AON11 = AON11_element;
TR11_9 = drift('ATR', 0.26569, 'DriftPass');
AMU11B = BPM_element;
TR11_10 = drift('ATR', 0.41301, 'DriftPass');
ACH11B = ACH_element;
TR11_11 = drift('ATR', 0.2126, 'DriftPass');
AMP11B = MARKER_element;
TR11_12 = drift('ATR', 0.0979, 'DriftPass');
AQF11B = A2QF11_element;
TR11_13 = drift('ATR', 0.1785, 'DriftPass');
ACV11B = ACV_element;
TR11_14 = drift('ATR', 0.1915, 'DriftPass');
AQD11B = A2QD11_element;
TR11_15 = drift('ATR', 0.828960086, 'DriftPass');
TR11 = [TR11_1 AQD11A TR11_2 ACV11A TR11_3 AQF11A TR11_4 AMP11A TR11_5 ACH11A TR11_6 AQS11 TR11_7 AMU11A TR11_8 AON11 TR11_9 AMU11B TR11_10 ACH11B TR11_11 AMP11B TR11_12 AQF11B TR11_13 ACV11B TR11_14 AQD11B TR11_15 ];
