...
TR02_4 = drift('ATR', 0.774, 'DriftPass');
ASF02 = A6SF_element;
TR02_5 = drift('ATR', 0.2845, 'DriftPass');
ACH02 = ACH_element;
TR02_6 = drift('ATR', 0.4855, 'DriftPass');
AQF02B = A6QF02_element;
TR02_7 = drift('ATR', 0.13, 'DriftPass');
AMP02B = BPM_element;
...
ACH03A = ACH_element;
TR03_6 = drift('ATR', 2.08117, 'DriftPass');
TR03_CENTER = MARKER_element;
TR03_7 = drift('ATR', 1.770772, 'DriftPass');
AMP03B = BPM_element;
TR03_8 = drift('ATR', 0.311398, 'DriftPass');
ACH03B = ACH_element;
TR03_9 = drift('ATR', 0.3155, 'DriftPass');
AQF03B = A2QF03_element;
TR03_10 = drift('ATR', 0.13233, 'DriftPass');
ACV03B = ACV_element;
TR03_11 = drift('ATR', 0.23667, 'DriftPass');
AQD03B = A2QD03_element;
TR03_12 = drift('ATR', 0.821490086, 'DriftPass');
TR03 = [TR03_1 AQD03A TR03_2 ACV03A TR03_3 AQF03A TR03_4 AMP03A TR03_5 ACH03A TR03_6 TR03_CENTER TR03_7 AMP03B TR03_8 ACH03B TR03_9 AQF03B TR03_10 ACV03B TR03_11 AQD03B TR03_12 ];
...
TR04_4 = drift('ATR', 0.774, 'DriftPass');
ASF04 = A6SF_element;
TR04_5 = drift('ATR', 0.2045, 'DriftPass');
ACH04 = ACH_element;
TR04_6 = drift('ATR', 0.5665, 'DriftPass');
AQF04B = A6QF01_element;
TR04_7 = drift('ATR', 0.13155, 'DriftPass');
AMP04B = BPM_element;
