...
QFC2.STRENGTH   = '1.961093182324501';
QFC2.LENGTH     = QUAD_LENGTH;
QFC2.PASSMETHOD = QUAD_PASSMETHOD;
QFC2.COR_FAMNH   = 'HCM';
QFC2.COR_FAMNV   = 'VCM';
QFC2.COR_PASSM  = 'CorrectorPass';
QFC2.TEMPLATE_ELEMENT = { ...
    'e1 = quadrupole(''FAMNAME'', LENGTH/2, STRENGTH, ''PASSMETHOD'');'; ...
    'e2 = corrector  (''COR_FAMNH'', 0.00000, [0 0], ''COR_PASSM'');'; ...
    'e3 = corrector  (''COR_FAMNV'', 0.00000, [0 0], ''COR_PASSM'');'; ...
    'e4 = quadrupole(''FAMNAME'', LENGTH/2, STRENGTH, ''PASSMETHOD'');'; ...  
    'TYPENAME_element = [e1 e2 e3 e4];'; ...
};
...
TYPES.A6QF01L = QFC2;
TYPES.A6QF01L.TYPENAME = 'A6QF01L';
TYPES.A6QF01L.FAMNAME  = 'A6QF01';

TYPES.A6QF02L = QFC2;
TYPES.A6QF02L.TYPENAME = 'A6QF02L';
TYPES.A6QF02L.FAMNAME  = 'A6QF02';
