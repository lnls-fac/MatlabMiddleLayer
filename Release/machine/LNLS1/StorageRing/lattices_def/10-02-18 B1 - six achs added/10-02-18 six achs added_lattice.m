...
% A6QF01L Template %
e1 = quadrupole('A6QF01', 0.27/2, 1.961093182324501, 'QuadLinearPass');
e2 = corrector  ('HCM', 0.00000, [0 0], 'CorrectorPass');
e3 = corrector  ('VCM', 0.00000, [0 0], 'CorrectorPass');
e4 = quadrupole('A6QF01', 0.27/2, 1.961093182324501, 'QuadLinearPass');
A6QF01L_element = [e1 e2 e3 e4];

% A6QF02L Template %
e1 = quadrupole('A6QF02', 0.27/2, 1.961093182324501, 'QuadLinearPass');
e2 = corrector  ('HCM', 0.00000, [0 0], 'CorrectorPass');
e3 = corrector  ('VCM', 0.00000, [0 0], 'CorrectorPass');
e4 = quadrupole('A6QF02', 0.27/2, 1.961093182324501, 'QuadLinearPass');
A6QF02L_element = [e1 e2 e3 e4];
