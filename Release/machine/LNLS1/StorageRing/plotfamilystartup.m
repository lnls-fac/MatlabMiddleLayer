...
%PLOTFAMILYSTARTUP - LNLS1 specific menus for the MML plotfamily function.
%
%História
%
...
Menu1 = uimenu(Menu0, 'Label', 'Analisar medidas de Offsets de BPMs do DiagMaq');
set(Menu1,'Callback', 'lnls1_analise_bba_diagmaq');
