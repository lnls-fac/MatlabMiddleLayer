...
if exist(default_filename, 'file')
    ...
    if strcmpi(getmode('BEND'), 'Online')
        ...
        bba = load_default_bba_config(bba_x_data, bba_y_data);
        %bba = load_corrector_range_from_last_measdata(bba);
        bba.configs.shunts.pause         = 0;
        bba.configs.shunts.nr_cycles     = 3;
        bba.configs.correctors.pause     = 0; 
        bba.configs.bpms.pause           = 0;
        bba.configs.bpms.nr_measurements = 5;
    end
end
...
BPMs = get_opr1_bpm_names; % get names in OPR1 order
idf = fopen(orbfile,'a');
for i=1:size(BPMs,1),
    flaX = 'nOK';
    flaY = 'nOK';
...
def_bpm_names = get_opr1_bpm_names;
...
function bpm_names = get_opr1_bpm_names
% Return BPM names in OPR1 order
% AMP03B and AMP03C are exchanged in OPR1's tables
bpm_names = [ ...
    'AMP01B'; ...
    'AMP02A'; 'AMP02B'; ...
    'AMP03A'; 'AMP03B'; 'AMP03C'; ...
    'AMP04A'; 'AMP04B'; ...
    'AMP05A'; 'AMP05B'; ...
    'AMP06A'; 'AMP06B'; ...
    'AMP07A'; 'AMP07B'; ...
