function newring = lnls1_set_id_field_luis(id, field, thering)
if nargin < 3
    global THERING
    thering = THERING;
end
...
% 
% This is a modified version of the lnls1_set_id_field of the LNLS1 library
% that works with local variables and takes into consideration a possible
% quadrupole correction for ID fields at UVX. It preserves the K parameter
% if there exists, and it keeps a "remanant" value K0 for the case in which
% the device is open. Currently (14/02/2017) it is unfinished. Made by Luis
% Yves Villegas Aguilar at the FAC group of LNLS.
