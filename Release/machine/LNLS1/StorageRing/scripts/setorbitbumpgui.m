...
% Last Modified by GUIDE v2.5 13-Jan-2012 16:56:42
...
commonnames = family2common(Family, BPMDeviceList); % XRR
BPMDeviceListString = '';
...
function HBPM2DevList_CreateFcn(hObject, eventdata, handles)
% hObject    handle to HBPM2DevList (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
