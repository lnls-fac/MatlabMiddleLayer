...
switch CommandInput
    ...
    case 'Symmetrize'
        ...
        % Scale factors
        Q1scale = FitParameters(1).Values(  1: 32) ./ FitParameters(le).Values(  1: 32);
        Q2scale = FitParameters(1).Values( 33: 64) ./ FitParameters(le).Values( 33: 64);
        Q3scale = FitParameters(1).Values( 65: 96) ./ FitParameters(le).Values( 65: 96);
        Q4scale = FitParameters(1).Values( 97:128) ./ FitParameters(le).Values( 97:128);
        Q5scale = FitParameters(1).Values(129:144) ./ FitParameters(le).Values(129:144);

        % Scale the magnet value when the LOCO run was done by the scale factor
        Q1new = Q1scale(:) .* LocoMeasData.MachineConfig.Q1.Setpoint.Data;
        Q2new = Q2scale(:) .* LocoMeasData.MachineConfig.Q2.Setpoint.Data;
        Q3new = Q3scale(:) .* LocoMeasData.MachineConfig.Q3.Setpoint.Data;
        Q4new = Q4scale(:) .* LocoMeasData.MachineConfig.Q4.Setpoint.Data;
        Q5new = Q5scale(:) .* LocoMeasData.MachineConfig.Q5.Setpoint.Data;
