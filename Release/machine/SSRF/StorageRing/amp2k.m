function [k, B] = amp2k(Family, Field, Value, DeviceList, Energy, BranchFlag)
%AMP2k - Converts SSRF control system values to the AT simulator values
%  [K, B] = amp2k(Family, Field, Value, DeviceList, Energy, BranchFlag)
%
%  INPUTS
