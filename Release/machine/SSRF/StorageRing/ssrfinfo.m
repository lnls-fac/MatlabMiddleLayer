function spsinfo
%SSRFINFO - Prints hypertext for useful websites and commands to the command window
%
...
fprintf('\n   Useful Websites\n');
fprintf('   <a href="http://www.ssrf.ac.cn">SSRF Homepage</a>');
fprintf('   <a href="http://lightsources.org/cms/">LightSources.Org</a>\n');

fprintf('\n   Useful Commands\n');
fprintf('   <a href="matlab: setpathmml;">setpathmml</a> - Sets the Matlab path for an accelerator (like <a href="matlab: setpathssrf;">SSRF</a> or <a href="matlab: setpathals;">ALS</a>)\n');
