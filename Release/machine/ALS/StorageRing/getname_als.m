...
for i = 1:size(DeviceList,1)
    ...
    elseif (strcmp(Family,'BPMx') && DevList==11 && (SectorList==3 || SectorList==5 || SectorList==10))
        ChanName = sprintf('SR%02dS___IBPM%1dX_%s00',  SectorList+1,  3, ChanTypeStr);
    elseif (strcmp(Family,'BPMy') && DevList==11 && (SectorList==3 || SectorList==5 || SectorList==10))
        ChanName = sprintf('SR%02dS___IBPM%1dY_%s01',  SectorList+1,  3, ChanTypeStr);
    elseif (strcmp(Family,'BPMx') && DevList==12 && (SectorList==3 || SectorList==5 || SectorList==10))
        ChanName = sprintf('SR%02dS___IBPM%1dX_%s02',  SectorList+1,  4, ChanTypeStr);
    elseif (strcmp(Family,'BPMy') && DevList==12 && (SectorList==3 || SectorList==5 || SectorList==10))
    ...
    elseif (strcmp(Family,'IDBPMx') && DevList==3 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dS___IBPM%1dX_%s00',  SectorList,  DevList, ChanTypeStr);
    elseif (strcmp(Family,'IDBPMy') && DevList==3 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dS___IBPM%1dY_%s01',  SectorList,  DevList, ChanTypeStr);
    elseif (strcmp(Family,'IDBPMx') && DevList==4 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dS___IBPM%1dX_%s02',  SectorList,  DevList, ChanTypeStr);
    elseif (strcmp(Family,'IDBPMy') && DevList==4 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dS___IBPM%1dY_%s03',  SectorList,  DevList, ChanTypeStr);
    ...
    elseif (strcmp(Family,'HCMFF2') && DevList==1 && (SectorList==4 || SectorList==11))
    ...
    elseif strcmp(Family,'HCMFF1') && DevList==8 && (SectorList==3 || SectorList==5 || SectorList==10)
    ...
    elseif (strcmp(Family,'HCMtimeconstant') && DevList==10)
    ...
    elseif (strcmp(Family,'HCMFF1') && DevList==10 && (SectorList==3 || SectorList==10))
        ChanName = sprintf('SR%02dU___HCM2FF1AC00',  SectorList+1);
    elseif (strcmp(Family,'HCMFF2') && DevList==10 && (SectorList==3 || SectorList==5 || SectorList==10))
    ...
    elseif (strcmp(Family,'VCMFF2') && DevList==1 && (SectorList==4 || SectorList==11))
    ...
    elseif (strcmp(Family,'VCMFF1') && DevList==8 && (SectorList==3 || SectorList==5 || SectorList==10))
    ...
    elseif (strcmp(Family,'VCMtimeconstant') && DevList==10)
    ...
    elseif (strcmp(Family,'VCMFF1') && DevList==10 && (SectorList==3 || SectorList==10))
        ChanName = sprintf('SR%02dU___VCM2FF1AC00',  SectorList+1);
    elseif (strcmp(Family,'VCMFF2') && DevList==10 && (SectorList==3 || SectorList==5 || SectorList==10))
    ...
    elseif (strcmp(Family,'SQSFdac') && DevList==1 && ChanTypeFlag==1)
        ChanName = sprintf('SR%02dC___SQSF1__AC10',  SectorList);
    elseif (strcmp(Family,'SQSFtimeconstant') && DevList==1 && ChanTypeFlag==1)
        ChanName = sprintf('SR%02dC___SQSF1__AC20',  SectorList);
    elseif (strcmp(Family,'SQSFramprate') && DevList==1 && ChanTypeFlag==1)
    ...
    elseif (strcmp(Family,'SQSFdac') && DevList==2 && ChanTypeFlag==1)
        ChanName = sprintf('SR%02dC___SQSF2__AC10',  SectorList);
    elseif (strcmp(Family,'SQSFtimeconstant') && DevList==2 && ChanTypeFlag==1)
        ChanName = sprintf('SR%02dC___SQSF2__AC20',  SectorList);
    elseif (strcmp(Family,'SQSFramprate') && DevList==2 && ChanTypeFlag==1)
    ...
    elseif (strcmp(Family,'SQSDdac') && DevList==1 && ChanTypeFlag==1)
        ChanName = sprintf('SR%02dC___SQSD1__AC10',  SectorList);
    elseif (strcmp(Family,'SQSDtimeconstant') && DevList==1 && ChanTypeFlag==1)
        ChanName = sprintf('SR%02dC___SQSD1__AC20',  SectorList);
    elseif (strcmp(Family,'SQSDramprate') && DevList==1 && ChanTypeFlag==1)
    ...
    elseif (strcmp(Family,'SQSDdac') && DevList==2 && ChanTypeFlag==1 && SectorList~=1)
        ChanName = sprintf('SR%02dC___SQSD2__AC10',  SectorList);
    elseif (strcmp(Family,'SQSDtimeconstant') && DevList==2 && ChanTypeFlag==1 && SectorList~=1)
        ChanName = sprintf('SR%02dC___SQSD2__AC20',  SectorList);
    elseif (strcmp(Family,'SQSDramprate') && DevList==2 && ChanTypeFlag==1 && SectorList~=1)
    ...
    elseif (strcmp(Family,'HCMCHICANEon') && (DevList==1 || DevList==3) && (ChanTypeFlag==0 || ChanTypeFlag==2) && SectorList==6)
    ...
    elseif (strcmp(Family,'HCMCHICANEon') && (DevList==1 || DevList==3) && (ChanTypeFlag==1 || ChanTypeFlag==3) && SectorList==6)
    ...
    elseif (strcmp(Family,'HCMCHICANEM') && DevList==1 && ChanTypeFlag==0 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dU___HCM2M1_AC00.RBV',  SectorList);
    elseif (strcmp(Family,'HCMCHICANEM') && DevList==2 && ChanTypeFlag==0 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dU___HCM2M2_AC01.RBV',  SectorList);
    elseif (strcmp(Family,'HCMCHICANEM') && DevList==3 && ChanTypeFlag==0 && (SectorList==4 || SectorList==11))
        ChanName = sprintf('SR%02dU___HCM2M3_AC02.RBV',  SectorList);
    elseif (strcmp(Family,'HCMCHICANEM') && DevList==1 && ChanTypeFlag==1 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dU___HCM2M1_AC00',  SectorList);
    elseif (strcmp(Family,'HCMCHICANEM') && DevList==2 && ChanTypeFlag==1 && (SectorList==4 || SectorList==6 || SectorList==11))
        ChanName = sprintf('SR%02dU___HCM2M2_AC01',  SectorList);
    elseif (strcmp(Family,'HCMCHICANEM') && DevList==3 && ChanTypeFlag==1 && (SectorList==4 || SectorList==11))
        ChanName = sprintf('SR%02dU___HCM2M3_AC02',  SectorList);
    ...
    elseif (strcmp(Family,'ID'))
        ...
        elseif (SectorList==4 || SectorList==11)
    ...
    elseif (strcmp(Family,'IDpos'))
        if (SectorList==5)
            ChanName = sprintf('SR%02dW___GDS1PS_%s00',    SectorList, ChanTypeStr);
        elseif (SectorList==4 || SectorList==6 || SectorList==11)
            ChanName = sprintf('SR%02dU___GDS%1dPS_%s00',  SectorList, DevList, ChanTypeStr);
        else
            ChanName = sprintf('SR%02dU___GDS1PS_%s00',    SectorList, ChanTypeStr);
        end
    ...
    elseif strcmp(Family,'UserGap')
        if SectorList==11 || (SectorList==4 && DevList==2)
    ...
    elseif strcmp(Family,'FFEnable') && SectorList==11
    ...
    elseif strcmp(Family,'GapEnable') && SectorList==11
    ...
    elseif strcmp(Family,'GapEnableBC') && SectorList==11
    ...
    elseif strcmp(Family,'EPUZMode')
        ChanName = sprintf('SR%02dU___ODS%1dM__DC01', SectorList, DevList);
    ...
    elseif strncmp(Family,'SQEPU',5)
        if SectorList==4
            ...
            elseif (strcmp(Family,'SQEPU') && DevList==2)
                error('No SR04 Q2 magnet yet.');
            else
                ChanName = ' ';
                ErrorFlag = -1;
            end
