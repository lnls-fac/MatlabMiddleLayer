...
setpv('SR06U___HCM2M1_BC00.VAL',1);
setpv('SR06U___HCM2M2_BC00.VAL',1);
...
while getpv('SR04U___HCM2M1_BC00.VAL')~=0 || getpv('SR04U___HCM2M2_BC00.VAL')~=0 || ...  % getpv('SR04U___HCM2M3_BC00.VAL')~=0 || ...
        getpv('SR06U___HCM2M1_BC00.VAL')~=0 || getpv('SR06U___HCM2M2_BC00.VAL')~=0 || ...
    ...
    if (gettime-t0)>120
        ...
        error('(SR04 Chicane: crate srioc040.als.lbl.gov, SR06 Chicane: crate srioc06u03, SR11 Chicane: srioc110.als.lbl.gov)');
    end
end
pause(2);
...
%end
if getam('SR06U___HCM2M1_BM00.VAL')==1
...
if getam('SR04U___HCM2M1_BM00.VAL')==0 && getam('SR04U___HCM2M2_BM00.VAL')==0  && getpv('SR04U___HCM2M1_BC00.VAL')==0 && getpv('SR04U___HCM2M2_BC00.VAL')==0 && getpv('SR04U___HCM2M3_BC00.VAL')==0
    %& getam('SR04U___HCM2M3_BM00.VAL')==0
...
if getam('SR06U___HCM2M1_BM00.VAL')==0 && getam('SR06U___HCM2M2_BM00.VAL')==0 && getpv('SR06U___HCM2M1_BC00.VAL')==0 && getpv('SR06U___HCM2M2_BC00.VAL')==0
...
if getam('SR11U___HCM2M1_BM00.VAL')==0 && getam('SR11U___HCM2M2_BM00.VAL')==0 && getpv('SR11U___HCM2M1_BC00.VAL')==0 && getpv('SR11U___HCM2M2_BC00.VAL')==0
    % & getpv('SR11U___HCM2M3_BC00.VAL')==0
    % getam('SR11U___HCM2M3_BM00.VAL')==0 &...
