...
if PhaseSpaceFlag == 0
    ...
    BL(i).ExtremeRay1 = 5;  % mm
%elseif PhaseSpaceFlag == 1 %this seemed like a bug - T.Scarvie-10-2-08 -
%Christoph?
...
% BL 8.3.1 Nominal Rays
% BL 8.3.1 Nominal Rays (06-18-2008 - no modification, includes different apertures)
%     i = i + 1;
%     BL(i).Title = 'BL 8.3.1';
%     BL(i).Number = [8 3 1];
%     BL(i).Data0 = [
