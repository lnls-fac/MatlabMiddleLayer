...
% else
    try
        fprintf('  12. run "resetudferrors" to clear all the UDF errors. It will not be run here!!!\n');
        %fprintf('  12. Setting the UDF fields for all families to 0 ... ');
        %resetudferrors;
        %fprintf('Done\n');
    catch
...
% Quad FF multipliers
try
    fprintf('  13. Setting the FF multipliers for the QF  & QD  families to 1 ... ');
...
try
    fprintf('  14. Setting the FF multipliers for the HCM & VCM families to 1 ... ');
...
fprintf('  16. Setting Third Harmonic Cavity defaults.\n');
...
fprintf('  17. Setting the golden orbit PVs to match what is in the MML.\n');
