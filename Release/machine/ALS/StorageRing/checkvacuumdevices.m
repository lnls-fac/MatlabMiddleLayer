...
if nargin < 1
    time = input('Collect data for how many minutes? (for default 2 minutes, hit return): ');
    if time < 1
...
IPlist = ['SR01C___IP1____AM00     507     '     
   ...
   % 'SR02S___IP2____AM00     508     '
     ...
     'SR03S___IP4____AM01     511     '
     'SR03S___IP5____AM02     511     '
     'SR03S___IP6____AM03     511     '
     'SR03S___IP7____AM04     511     '
     ...
     'SR06S___IP1____AM00     516     '
     'SR06S___IP2____AM00     516     '
