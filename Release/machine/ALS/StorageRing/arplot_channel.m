function data = arplot_channel(channel,monthStr, days, year1, month2Str, days2, year2)
% arplot_channel(channel,Month1 String, Days1, Year1, Month2 String, Days2, Year2)
%
