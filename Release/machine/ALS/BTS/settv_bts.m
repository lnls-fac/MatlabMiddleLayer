function ErrorFlag = settv_bts(Family, varargin)
%SETTV_BTS - Sets both the paddle and lamp
%  Error = settv_bts(Family, InOutControl, DeviceList, WaitFlag)
%  Error = settv_bts(Family, Field, InOutControl, DeviceList, WaitFlag)
%
