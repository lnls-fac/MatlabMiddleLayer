function ErrorFlag = setltb(Family, Field, NewSP, DeviceList, WaitFlag) 
%SETLTB - Ramps the LTB magnets in steps to avoid overshoots and trips
%  ErrorFlag = setltb(Family, Field, NewSP, DeviceList, MaxStep, WaitFlag)
