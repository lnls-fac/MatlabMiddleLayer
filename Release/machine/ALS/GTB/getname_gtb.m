...
elseif strcmpi(Family, 'HCM') && strcmpi(Field, 'DC_24V_OK')
    ChannelNames = [
        'GTL_____HC1____BM05' % +24V
        'GTL_____HC2____BM13' % +24V
        'GTL_____HC3____BM05' % +24V
        'GTL_____HC4____BM13' % +24V
        'LN______HC1____BM13' % +24V
        'LN______HC2____BM05' % +24V
        '                   '
        '                   '
        '                   '
        ];

elseif strcmpi(Family, 'HCM') && strcmpi(Field, 'LOCAL')
    ChannelNames = [
        'GTL_____HC1____BM00' % LOCAL
        'GTL_____HC2____BM08' % LOCAL
        'GTL_____HC3____BM00' % LOCAL
        'GTL_____HC4____BM08' % LOCAL
        'LN______HC1____BM08' % LOCAL
        'LN______HC2____BM00' % LOCAL
        '                   '
        '                   '
        '                   '
        ];

elseif strcmpi(Family, 'HCM') && strcmpi(Field, 'COMPUTER')
    ChannelNames = [
        'GTL_____HC1____BM01' % COMPUTER
        'GTL_____HC2____BM09' % COMPUTER
        'GTL_____HC3____BM01' % COMPUTER
        'GTL_____HC4____BM09' % COMPUTER
        'LN______HC1____BM09' % COMPUTER
        'LN______HC2____BM01' % COMPUTER
        '                   '
        '                   '
        '                   '
        ];

elseif strcmpi(Family, 'HCM') && strcmpi(Field, 'EXT_INTLK_OK')
    ChannelNames = [
        'GTL_____HC1____BM02' % EXT_INTLK_OK
        'GTL_____HC2____BM10' % EXT_INTLK_OK
        'GTL_____HC3____BM02' % EXT_INTLK_OK
        'GTL_____HC4____BM10' % EXT_INTLK_OK
        'LN______HC1____BM10' % EXT_INTLK_OK
        'LN______HC2____BM02' % EXT_INTLK_OK
        '                   '
        '                   '
        '                   '
        ];

elseif strcmpi(Family, 'HCM') && strcmpi(Field, 'PS_THERM_OK')
    ChannelNames = [
        'GTL_____HC1____BM03' % PS_THERM_OK
        'GTL_____HC2____BM11' % PS_THERM_OK
        'GTL_____HC3____BM03' % PS_THERM_OK
        'GTL_____HC4____BM11' % PS_THERM_OK
        'LN______HC1____BM11' % PS_THERM_OK
        'LN______HC2____BM03' % PS_THERM_OK
        '                   '
        '                   '
        '                   '
        ];

elseif strcmpi(Family, 'HCM') && strcmpi(Field, 'AC_120V_OK')
    ChannelNames = [
        'GTL_____HC1____BM04' % 120VAC_OK
        'GTL_____HC2____BM12' % 120VAC_OK
        'GTL_____HC3____BM04' % 120VAC_OK
        'GTL_____HC4____BM12' % 120VAC_OK
        'LN______HC1____BM12' % 120VAC_OK
        'LN______HC2____BM04' % 120VAC_OK
        '                   '
        '                   '
        '                   '
        ];
...
elseif strcmpi(Family, 'BEND') && strcmpi(Field, 'OverTemperature')
    ...
    % 'LTB_____BS_FC__BC23', 'BS_FC_CNTRL'
    % 'LTB_____BS_LTB_BC22', 'BS_LTB_CNTRL'
    
    % 'LTB_____B1_SHNTAM03	% B1_PS_SHUNT
    % 'LTB_____BS_SHNTAM00	% BS_PS_SHUNT
    
    % 'LTB_____BS_____BM02' % BS_SAFETY_CHAIN
    % 'LTB_____BS_____BM01' % BS_MAG_INTLK
    % 'LTB_____BS_FC__BM10' % BS_FC_MONITOR
    % 'LTB_____BS_LTB_BM11' % BS_LTB_MON
...
% 'GTL_____IG1____AM01	CONV GAUGE
% 'GTL_____IG2____AM00	ION GAUGE x
% 'GTL_____IG2____AM01	CONV GAUGE
% 'GTL_____IP1____AM01	% GLT IP1 PRESSURE
% 'GTL_____IP2____AM02	% GLT IP2 PRESSURE
% 'LN______IG1____AM00	ION GAUGE
% 'LN______IG1____AM01	CONV GAUGE
