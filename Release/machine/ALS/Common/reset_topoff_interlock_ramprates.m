...
disp('Setting SR01 SF magnet ramprate to 4.3 A/s');
setpv('SR01C___SF_____AC30.DRVH',1000);
setpv('SR01C___SF_____AC30',4.3);

disp('Setting SR01 SD magnet ramprate to 4.3 A/s');
setpv('SR01C___SD_____AC30.DRVH',1000);
setpv('SR01C___SD_____AC30',4.3);
