...
% tmp = questdlg('Change the booster QD ramp table?','setboosterrampqd','Yes','No','No');
% if ~strcmpi(tmp,'Yes')
...
% Enable the DAC 
setpv('BR1_____QDIE_REBC02', 1);

% Set the gain
Gain = 0.2;  
% setpv('BR1_____QDIE_GNAC02', Gain);
...
fprintf('   BR1_____QDIE_REBC02   = %d\n', getpv('BR1_____QDIE_REBC02'));
fprintf('   BR1_____QDIE_GNAC01   = %d\n', getpv('BR1_____QDIE_GNAC02'));
