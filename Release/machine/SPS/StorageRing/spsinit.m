...
%AO.QF.Monitor.HW2PhysicsFcn = @sps2at;
%AO.QF.Monitor.Physics2HWFcn = @at2sps;
...
%AO.QD.Monitor.HW2PhysicsFcn = @sps2at;
%AO.QD.Monitor.Physics2HWFcn = @at2sps;
...
%AO.QFA.Monitor.HW2PhysicsFcn = @sps2at;
%AO.QFA.Monitor.Physics2HWFcn = @at2sps;
...
AO.QDA.Monitor.HW2PhysicsParams = -6.631929e-3;    % K/Ampere:  HW2Physics*Amps=K
AO.QDA.Monitor.Physics2HWParams = 1 ./ AO.QDA.Monitor.HW2PhysicsParams;
%AO.QDA.Monitor.HW2PhysicsFcn = @sps2at;
%AO.QDA.Monitor.Physics2HWFcn = @at2sps;
