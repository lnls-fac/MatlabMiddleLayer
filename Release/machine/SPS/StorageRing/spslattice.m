...
D09     = drift('D09' ,0.10100000,'DriftPass');
D10     = drift('D10' ,0.06950000,'DriftPass');
D11     = drift('D11' ,1.17700000,'DriftPass');
D12     = drift('D12' ,0.07750000,'DriftPass');
D13     = drift('D13' ,0.10100000,'DriftPass');
D14     = drift('D14' ,0.10100000,'DriftPass');
D15     = drift('D15' ,0.04900000,'DriftPass');
D16     = drift('D16' ,1.10550000,'DriftPass');
D17     = drift('D17' ,0.06950000,'DriftPass');
D18     = drift('D18' ,0.10100000,'DriftPass');
...
D2X     = drift('D2X', 0.04900000, 'DriftPass');
D5X     = drift('D5X', 0.07750000, 'DriftPass');
...
SPERIOD1 =  [ D01 CORH1 D02 BPM D03 QF11 D04 CORV1 D05 QD21 D06 B01... 
            D07 BPM D08 QF31 D09 SF D10 CORH2 D11 BPM D12 SD D13 QD41 D14 SD...
            D15 CORV2 D16 CORH3 D17 SF D18 QF32 D19 BPM D20 B02...
            D21 QD22 D22 CORV3 D23 QF12 D24 BPM D25 CORH4 D26 ];
            
SPERIOD2 =  [ D01 CORH5 D02 BPM D03 QF11 D04 CORV4 D05 QD21 D06 B01... 
            D07 BPM D08 QF31 D09 SF D10 CORH6 D1X CORV5 D2X SD D13 QD41 D14 SD...
            D5X BPM D6X CORH7 D17 SF D18 QF32 D19 BPM D20 B02...
            D21 QD22 D22 CORV6 D23 QF12 D24 BPM D25 CORH8 DRFB CAV DRFC DRFA ];
            
SPERIOD3 =  [ D01 CORH9 D02 BPM D03 QF11 D04 CORV7 D05 QD21 D06 B01... 
            D07 BPM D08 QF31 D09 SF D10 CORH10 D11 BPM D12 SD D13 QD41 D14 SD...
            D15 CORV8 D16 CORH11 D17 SF D18 QF32 D19 BPM D20 B02...
            D21 QD22 D22 CORV9 D23 QF12 D24 BPM D25 CORH12 D26 ];  
            
SPERIOD4 =  [ D01 CORH13 D02 BPM D03 QF11 D04 CORV10 D05 QD21 D06 B01... 
            D07 BPM D08 QF31 D09 SF D10 CORH14 D1X CORV11 D2X SD D13 QD41 D14 SD...
            D5X BPM D6X CORH15 D17 SF D18 QF32 D19 BPM D20 B02...
