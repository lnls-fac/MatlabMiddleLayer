function [k, B] = sns2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%SNS2AT - Converts control system values to the AT simulator values
%  [K, B] = sns2at(Family, Field, Value, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also at2sns, hw2physics, physics2hw
