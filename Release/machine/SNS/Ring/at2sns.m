function [Value, B] = at2sns(Family, Field, k, DeviceList, Energy, BranchFlag)
%AT2SNS - Converts the AT simulator values to control system values
%  [Value, B] = at2sns(Family, Field, K, DeviceList, Energy, BranchFlag)
%
%  INPUTS
...
%
%  See also sns2at, hw2physics, physics2hw
