...
AO.spec.DeviceList  = getDeviceList(1,2);
...
AO.spec.Monitor.ChannelNames = getname(AO.spec.FamilyName, 'Monitor', AO.spec.DeviceList);
AO.spec.Monitor.HW2PhysicsParams = 1;
AO.spec.Monitor.Physics2HWParams = 1;
...
AO.spec.Setpoint.ChannelNames = getname(AO.spec.FamilyName, 'Setpoint', AO.spec.DeviceList);
AO.spec.Setpoint.HW2PhysicsParams = 1;
AO.spec.Setpoint.Physics2HWParams = 1;
...
AO.septin.Monitor.ChannelNames = getname(AO.septin.FamilyName, 'Monitor', AO.septin.DeviceList);
AO.septin.Monitor.HW2PhysicsParams = 1;
AO.septin.Monitor.Physics2HWParams = 1;
AO.septin.Monitor.Units        = 'Hardware';
AO.septin.Monitor.HWUnits      = 'Ampere';
AO.septin.Monitor.PhysicsUnits = 'GeV';

AO.septin.Setpoint.MemberOf = {'MachineConfig';};
AO.septin.Setpoint.Mode = 'Simulator';
AO.septin.Setpoint.DataType = 'Scalar';
AO.septin.Setpoint.ChannelNames = getname(AO.septin.FamilyName, 'Setpoint', AO.septin.DeviceList);
AO.septin.Setpoint.HW2PhysicsParams = 1;
AO.septin.Setpoint.Physics2HWParams = 1;
AO.septin.Setpoint.Units        = 'Hardware';
AO.septin.Setpoint.HWUnits      = 'Ampere';
AO.septin.Setpoint.PhysicsUnits = 'GeV';
...
AO.q1a.Setpoint.ChannelNames = getname(AO.q1a.FamilyName, 'Setpoint', AO.q1a.DeviceList);
...
AO.q1b.Setpoint.ChannelNames = getname(AO.q1b.FamilyName, 'Setpoint', AO.q1b.DeviceList);
...
AO.q1c.Setpoint.ChannelNames = getname(AO.q1c.FamilyName, 'Setpoint', AO.q1c.DeviceList);
...
AO.qd3a.Setpoint.ChannelNames = getname(AO.qd3a.FamilyName, 'Setpoint', AO.qd3a.DeviceList);
...
AO.qf3a.Setpoint.ChannelNames = getname(AO.qf3a.FamilyName, 'Setpoint', AO.qf3a.DeviceList);
...
AO.qf3b.Setpoint.ChannelNames = getname(AO.qf3b.FamilyName, 'Setpoint', AO.qf3b.DeviceList);
...
AO.qd3b.Setpoint.ChannelNames = getname(AO.qd3b.FamilyName, 'Setpoint', AO.qd3b.DeviceList);
...
AO.qd4.Setpoint.ChannelNames  = getname(AO.qd4.FamilyName, 'Setpoint', AO.qd4.DeviceList);
...
AO.qf5.Setpoint.ChannelNames = getname(AO.qf5.FamilyName, 'Setpoint', AO.qf5.DeviceList);
...
AO.qd5.Setpoint.ChannelNames = getname(AO.qd5.FamilyName, 'Setpoint', AO.qd5.DeviceList);
