...
% BENDS
AO.bspec.FamilyName  = 'bspec';
AO.bspec.MemberOf    = {'PlotFamily'; 'bspec'; 'BEND'; 'Magnet';};
AO.bspec.DeviceList  = getDeviceList(1,2);
AO.bspec.ElementList = (1:size(AO.bspec.DeviceList,1))';
AO.bspec.Status      = ones(size(AO.bspec.DeviceList,1),1);
AO.bspec.Position    = [];

AO.bspec.Monitor.MemberOf = {};
AO.bspec.Monitor.Mode = 'Simulator';
AO.bspec.Monitor.DataType = 'Scalar';
AO.bspec.Monitor.ChannelNames = getname(AO.bspec.FamilyName, 'Monitor', AO.bspec.DeviceList);
AO.bspec.Monitor.HW2PhysicsParams = 1;
AO.bspec.Monitor.Physics2HWParams = 1;
AO.bspec.Monitor.Units        = 'Hardware';
AO.bspec.Monitor.HWUnits      = 'Ampere';
AO.bspec.Monitor.PhysicsUnits = 'GeV';

AO.bspec.Setpoint.MemberOf = {'MachineConfig';};
AO.bspec.Setpoint.Mode = 'Simulator';
AO.bspec.Setpoint.DataType = 'Scalar';
AO.bspec.Setpoint.ChannelNames = getname(AO.bspec.FamilyName, 'Setpoint', AO.bspec.DeviceList);
AO.bspec.Setpoint.HW2PhysicsParams = 1;
AO.bspec.Setpoint.Physics2HWParams = 1;
AO.bspec.Setpoint.Units        = 'Hardware';
AO.bspec.Setpoint.HWUnits      = 'Ampere';
AO.bspec.Setpoint.PhysicsUnits = 'GeV';
AO.bspec.Setpoint.Range        = [0 300];
AO.bspec.Setpoint.Tolerance    = .1;
AO.bspec.Setpoint.DeltaRespMat = .01;
...
AO.bseptinj.FamilyName  = 'bseptinj';
AO.bseptinj.MemberOf    = {'PlotFamily'; 'bseptinj'; 'BEND'; 'Magnet';};
AO.bseptinj.DeviceList  = getDeviceList(1,2);
AO.bseptinj.ElementList = (1:size(AO.bseptinj.DeviceList,1))';
AO.bseptinj.Status      = ones(size(AO.bseptinj.DeviceList,1),1);
AO.bseptinj.Position    = [];

AO.bseptinj.Monitor.MemberOf = {};
AO.bseptinj.Monitor.Mode = 'Simulator';
AO.bseptinj.Monitor.DataType = 'Scalar';
AO.bseptinj.Monitor.ChannelNames = getname(AO.bseptinj.FamilyName, 'Monitor', AO.bseptinj.DeviceList);
AO.bseptinj.Monitor.HW2PhysicsParams = 1;
AO.bseptinj.Monitor.Physics2HWParams = 1;
AO.bseptinj.Monitor.Units        = 'Hardware';
AO.bseptinj.Monitor.HWUnits      = 'Ampere';
AO.bseptinj.Monitor.PhysicsUnits = 'GeV';

AO.bseptinj.Setpoint.MemberOf = {'MachineConfig';};
AO.bseptinj.Setpoint.Mode = 'Simulator';
AO.bseptinj.Setpoint.DataType = 'Scalar';
AO.bseptinj.Setpoint.ChannelNames = getname(AO.bseptinj.FamilyName, 'Setpoint', AO.bseptinj.DeviceList);
AO.bseptinj.Setpoint.HW2PhysicsParams = 1;
AO.bseptinj.Setpoint.Physics2HWParams = 1;
AO.bseptinj.Setpoint.Units        = 'Hardware';
AO.bseptinj.Setpoint.HWUnits      = 'Ampere';
AO.bseptinj.Setpoint.PhysicsUnits = 'GeV';
AO.bseptinj.Setpoint.Range        = [0 300];
AO.bseptinj.Setpoint.Tolerance    = .1;
AO.bseptinj.Setpoint.DeltaRespMat = .01;
