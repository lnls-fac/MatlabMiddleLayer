...
try
    % sdba0
    AO.sdba0.AT.ATType = 'Sext';
    AO.sdba0.AT.ATIndex = buildatindex(AO.sdba0.FamilyName, Indices.sdba0);
    AO.sdba0.Position = findspos(THERING, AO.sdba0.AT.ATIndex(:,1))';
catch
    warning('sdba0 family not found in the model.');
end

try
    % sdbp0
    AO.sdbp0.AT.ATType = 'Sext';
    AO.sdbp0.AT.ATIndex = buildatindex(AO.sdbp0.FamilyName, Indices.sdbp0);
    AO.sdbp0.Position = findspos(THERING, AO.sdbp0.AT.ATIndex(:,1))';
catch
    warning('sdbp0 family not found in the model.');
end
...
try
    % sdba1
    AO.sdba1.AT.ATType = 'Sext';
    AO.sdba1.AT.ATIndex = buildatindex(AO.sdba1.FamilyName, Indices.sdba1);
    AO.sdba1.Position = findspos(THERING, AO.sdba1.AT.ATIndex(:,1))';
catch
    warning('sdba1 family not found in the model.');
end

try
    % sdbp1
    AO.sdbp1.AT.ATType = 'Sext';
    AO.sdbp1.AT.ATIndex = buildatindex(AO.sdbp1.FamilyName, Indices.sdbp1);
    AO.sdbp1.Position = findspos(THERING, AO.sdbp1.AT.ATIndex(:,1))';
catch
    warning('sdbp1 family not found in the model.');
end
...
try
    % sdba2
    AO.sdba2.AT.ATType = 'Sext';
    AO.sdba2.AT.ATIndex = buildatindex(AO.sdba2.FamilyName, Indices.sdba2);
    AO.sdba2.Position = findspos(THERING, AO.sdba2.AT.ATIndex(:,1))';
catch
    warning('sdba2 family not found in the model.');
end

try
    % sdbp2
    AO.sdbp2.AT.ATType = 'Sext';
    AO.sdbp2.AT.ATIndex = buildatindex(AO.sdbp2.FamilyName, Indices.sdbp2);
    AO.sdbp2.Position = findspos(THERING, AO.sdbp2.AT.ATIndex(:,1))';
catch
    warning('sdbp2 family not found in the model.');
end
...
try
    % sdba3
    AO.sdba3.AT.ATType = 'Sext';
    AO.sdba3.AT.ATIndex = buildatindex(AO.sdba3.FamilyName, Indices.sdba3);
    AO.sdba3.Position = findspos(THERING, AO.sdba3.AT.ATIndex(:,1))';
catch
    warning('sdba3 family not found in the model.');
end

try
    % sdbp3
    AO.sdbp3.AT.ATType = 'Sext';
    AO.sdbp3.AT.ATIndex = buildatindex(AO.sdbp3.FamilyName, Indices.sdbp3);
    AO.sdbp3.Position = findspos(THERING, AO.sdbp3.AT.ATIndex(:,1))';
catch
    warning('sdbp3 family not found in the model.');
end
...
try
    % sfba0
    AO.sfba0.AT.ATType = 'Sext';
    AO.sfba0.AT.ATIndex = buildatindex(AO.sfba0.FamilyName, Indices.sfba0);
    AO.sfba0.Position = findspos(THERING, AO.sfba0.AT.ATIndex(:,1))';
catch
    warning('sfba0 family not found in the model.');
end

try
    % sfbp0
    AO.sfbp0.AT.ATType = 'Sext';
    AO.sfbp0.AT.ATIndex = buildatindex(AO.sfbp0.FamilyName, Indices.sfbp0);
    AO.sfbp0.Position = findspos(THERING, AO.sfbp0.AT.ATIndex(:,1))';
catch
    warning('sfbp0 family not found in the model.');
end
...
try
    % sfba1
    AO.sfba1.AT.ATType = 'Sext';
    AO.sfba1.AT.ATIndex = buildatindex(AO.sfba1.FamilyName, Indices.sfba1);
    AO.sfba1.Position = findspos(THERING, AO.sfba1.AT.ATIndex(:,1))';
catch
    warning('sfba1 family not found in the model.');
end

try
    % sfbp1
    AO.sfbp1.AT.ATType = 'Sext';
    AO.sfbp1.AT.ATIndex = buildatindex(AO.sfbp1.FamilyName, Indices.sfbp1);
    AO.sfbp1.Position = findspos(THERING, AO.sfbp1.AT.ATIndex(:,1))';
catch
    warning('sfbp1 family not found in the model.');
end
...
try
    % sfba2
    AO.sfba2.AT.ATType = 'Sext';
    AO.sfba2.AT.ATIndex = buildatindex(AO.sfba2.FamilyName, Indices.sfba2);
    AO.sfba2.Position = findspos(THERING, AO.sfba2.AT.ATIndex(:,1))';
catch
    warning('sfba2 family not found in the model.');
end

try
    % sfbp2
    AO.sfbp2.AT.ATType = 'Sext';
    AO.sfbp2.AT.ATIndex = buildatindex(AO.sfbp2.FamilyName, Indices.sfbp2);
    AO.sfbp2.Position = findspos(THERING, AO.sfbp2.AT.ATIndex(:,1))';
catch
    warning('sfbp2 family not found in the model.');
end
