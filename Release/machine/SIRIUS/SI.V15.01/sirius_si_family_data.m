...
data.sda0.nr_segs  = 1;
data.sdba0.nr_segs = 1;
data.sdbp0.nr_segs = 1;
data.sdp0.nr_segs  = 1;
data.sda1.nr_segs  = 1;
data.sdba1.nr_segs = 1;
data.sdbp1.nr_segs = 1;
data.sdp1.nr_segs  = 1;
data.sda2.nr_segs  = 1;
data.sdba2.nr_segs = 1;
data.sdbp2.nr_segs = 1;
data.sdp2.nr_segs  = 1;
data.sda3.nr_segs  = 1;
data.sdba3.nr_segs = 1;
data.sdbp3.nr_segs = 1;
data.sdp3.nr_segs  = 1;
data.sfa0.nr_segs  = 1;
data.sfba0.nr_segs = 1;
data.sfbp0.nr_segs = 1;
data.sfp0.nr_segs  = 1;
data.sfa1.nr_segs  = 1;
data.sfba1.nr_segs = 1;
data.sfbp1.nr_segs = 1;
data.sfp1.nr_segs  = 1;
data.sfa2.nr_segs  = 1;
data.sfba2.nr_segs = 1;
data.sfbp2.nr_segs = 1;
data.sfp2.nr_segs  = 1;
...
idx = [idx; data.sfba0.ATIndex];
idx = [idx; data.sfbp0.ATIndex];
idx = [idx; data.sfp0.ATIndex];
idx = [idx; data.sda1.ATIndex];
idx = [idx; data.sdba1.ATIndex];
idx = [idx; data.sdbp1.ATIndex];
idx = [idx; data.sdp1.ATIndex];
idx = [idx; data.sfa2.ATIndex];
idx = [idx; data.sfba2.ATIndex];
idx = [idx; data.sfbp2.ATIndex];
...
idx = [idx; data.sdba3.ATIndex];
idx = [idx; data.sdbp3.ATIndex];
...
idx = [idx; data.sdba0.ATIndex];
idx = [idx; data.sdbp0.ATIndex];
idx = [idx; data.sdp0.ATIndex];
idx = [idx; data.sfa1.ATIndex];
idx = [idx; data.sfba1.ATIndex];
idx = [idx; data.sfbp1.ATIndex];
...
idx = [idx; data.sdba2.ATIndex];
idx = [idx; data.sdbp2.ATIndex];
