...
% 2018-08-21 adding new fmap analysis of dipole model 09 with x0=9.1013mm (x-ref = 28.255 mm)
% 2018-08-21 model individual dipoles from measurement fmap analysis data.
...
L00880  = drift('l00880',  0.08800, 'DriftPass');
L01335  = drift('l01335',  0.13350, 'DriftPass');
...
US_CS      = [D02475, SD, L02725, CV, GIR, L13710, BPM,    L18210, GIR, CH, L01610];
