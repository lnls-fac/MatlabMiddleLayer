...
% Add additional directories with SIRIUS3 specific stuff.
MMLROOT = getmmlroot('IgnoreTheAD');
addpath(fullfile(MMLROOT,'machine','SIRIUS3','StorageRing','scripts'), '-begin');
...
AO.skewcm.DeviceList  = getDeviceList(10,8);
