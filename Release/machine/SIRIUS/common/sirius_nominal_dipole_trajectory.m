...
elseif strcmpi(dipole_famname, 'BC')
    ...
    idx = idx(length(idx)/2+1:end); % z>0 half dipole
    % average for all measured BC dipoles:
    ...
    ang_medio_new = (pi/180.0)*[0.01877,0.07328,0.08149,0.06914,0.05972,0.09814,0.07568,0.05755,0.04544,0.11887,0.09720,0.62161,0.62274,0.04249,0.03339,0.01935,0.01344]';
    ang = ang_medio_new;
