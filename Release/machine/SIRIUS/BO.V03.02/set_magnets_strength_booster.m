...
% % 2016-02-11 ximenes
% % model6 of dipoles made of 2 segments. one type of end plate. corrected
% % current.
% tunes fitted to [19.204329999469028   7.314170055590468]
% chroms fitted to [0.5 0.5]
qf_strength = 1.661848721015686;
qd_strength = -0.060292099358491;
sf_strength = 11.306272038087426;
sd_strength = 8.673631489209185;
