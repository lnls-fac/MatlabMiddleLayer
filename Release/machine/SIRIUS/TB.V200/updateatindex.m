...
try
    ...
    AO.qb2.Position = findspos(THERING, AO.qb1.AT.ATIndex(:,1))';
catch
    warning('qb2 family not found in the model.');
end
try
    % qb3
    AO.qb3.AT.ATType = 'Quad';
    AO.qb3.AT.ATIndex = buildatindex(AO.qb3.FamilyName, Indices.qb3);
    AO.qb3.Position = findspos(THERING, AO.qb3.AT.ATIndex(:,1))';
catch
    warning('qb3 family not found in the model.');
end
...
try
    ...
    AO.qd2.Position = findspos(THERING, AO.qd1.AT.ATIndex(:,1))';
catch
...
try
    ...
    AO.qe2.Position = findspos(THERING, AO.qe1.AT.ATIndex(:,1))';
catch
