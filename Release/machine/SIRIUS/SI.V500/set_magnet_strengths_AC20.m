% set_magnet_strengths_V500_AC20
% ==============================
...
elseif strcmpi(mode_version, 'AC20_2')
    ...
    % Ao analisarmos o efeito dos IDs sobre a abertura dinamica a vers???o AC20_1 com a qual
    % vinhamos trabalhando se mostrou susceptivel a perturbacao. Houve consideravel reducao
    % da abertura din???mica. Resolvemos entao testar a versao antiga 3mad que se mostrou mais
    % imune aos IDs e renomea-la para AC20_2
...
%%
%As redes abaixo foram usadas como teste para mudanca do AC20_0 para o
