...
AO.Spect.Position    = [];
AO.Spect.ExcitationCurves = sirius_getexcdata(repmat('tbma-bend', size(AO.Spect.DeviceList,1), 1)); 
...
AO.B.Position    = [];
AO.B.ExcitationCurves = sirius_getexcdata(repmat('tbma-bend', size(AO.B.DeviceList,1), 1));
...
AO.InjS.Position    = [];
AO.InjS.ExcitationCurves = sirius_getexcdata(repmat('tbma-bend', size(AO.InjS.DeviceList,1), 1));
...
AO.QF3L.Position    = [];
AO.QF3L.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QF3L.DeviceList,1), 1));
...
AO.QD1.Position    = [];
AO.QD1.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QD1.DeviceList,1), 1));
...
AO.QF1.Position    = [];
AO.QF1.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QF1.DeviceList,1), 1));
...
AO.QD2A.Position    = [];
AO.QD2A.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QD2A.DeviceList,1), 1));
...
AO.QF2A.Position    = [];
AO.QF2A.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QF2A.DeviceList,1), 1));
...
AO.QF2B.Position    = [];
AO.QF2B.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QF2B.DeviceList,1), 1));
...
AO.QD2B.Position    = [];
AO.QD2B.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QD2B.DeviceList,1), 1));
...
AO.QF3.Position    = [];
AO.QF3.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QF3.DeviceList,1), 1));
...
AO.QD3.Position    = [];
AO.QD3.ExcitationCurves = sirius_getexcdata(repmat('tbma-q', size(AO.QD3.DeviceList,1), 1));
