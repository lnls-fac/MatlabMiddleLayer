...
SDB0 = sextupole('sdb0', 0.150, sdb0_strength, sext_pass_method); % CH-CV
...
SDB1 = sextupole('sdb1', 0.150, sdb1_strength, sext_pass_method); % QS
...
SDB2 = sextupole('sdb2', 0.150, sdb2_strength, sext_pass_method); % CH-CV
