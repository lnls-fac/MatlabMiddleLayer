...
AD = getad;
AD.Machine             = 'SIRIUS_V21.03';   % Will already be defined if setpathmml was used
...
AD.OperationalMode     = 'V21.03_S10.01';
AD.Energy              = 3.0;
...
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.MachineType         = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V21.03_S05.03';
AD.Energy              = 3.0;
AD.InjectionEnergy     = 3.0;
AD.ModeName            = 'S05';
AD.ModeVersion         = '03';
...
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.MachineType         = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V21.03_S05.02';
AD.Energy              = 3.0;
AD.InjectionEnergy     = 3.0;
AD.ModeName            = 'S05';
AD.ModeVersion         = '02';
...
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.MachineType         = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V21.03_S05.01';
AD.Energy              = 3.0;
AD.InjectionEnergy     = 3.0;
AD.ModeName            = 'S05';
AD.ModeVersion         = '01';
