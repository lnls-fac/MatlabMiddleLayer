...
AO.septex.Position    = [];
AO.septex.ExcitationCurves = sirius_getexcdata(repmat('tsma-sep', size(AO.septex.DeviceList,1), 1)); 
...
AO.septing.Position    = [];
AO.septing.ExcitationCurves = sirius_getexcdata(repmat('tsma-sep', size(AO.septing.DeviceList,1), 1)); 
...
AO.septinf.Position    = [];
AO.septinf.ExcitationCurves = sirius_getexcdata(repmat('tsma-sep', size(AO.septinf.DeviceList,1), 1)); 
