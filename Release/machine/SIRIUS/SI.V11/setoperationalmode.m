...
AD = getad;
AD.Machine             = 'SIRIUS_V11';  % Will already be defined if setpathmml was used
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V11_A00';
AD.Energy              = 3.0;
...
AD = getad;
AD.Machine             = 'SIRIUS.V11';           % Will already be defined if setpathmml was used
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V11.C01';
AD.Energy              = 3.0;
AD.InjectionEnergy     = 3.0;
AD.ModeName            = 'C';
AD.ModeVersion         = '01';
