...
AO.qfa.Monitor.ChannelNames = sirius_getname(AO.qfa.FamilyName, 'Monitor', AO.qfa.DeviceList);
...
AO.qfa.Setpoint.ChannelNames  = sirius_getname(AO.qfa.FamilyName, 'Setpoint', AO.qfa.DeviceList);
...
AO.qdb2.Monitor.ChannelNames = sirius_getname(AO.qdb2.FamilyName, 'Monitor', AO.qdb2.DeviceList);
...
AO.qdb2.Setpoint.ChannelNames  = sirius_getname(AO.qdb2.FamilyName, 'Setpoint', AO.qdb2.DeviceList);
...
AO.qfb.Monitor.ChannelNames = sirius_getname(AO.qfb.FamilyName, 'Monitor', AO.qfb.DeviceList);
...
AO.qfb.Setpoint.ChannelNames  = sirius_getname(AO.qfb.FamilyName, 'Setpoint', AO.qfb.DeviceList);
...
AO.qdb1.Monitor.ChannelNames = sirius_getname(AO.qdb1.FamilyName, 'Monitor', AO.qdb1.DeviceList);
...
AO.qdb1.Setpoint.ChannelNames  = sirius_getname(AO.qdb1.FamilyName, 'Setpoint', AO.qdb1.DeviceList);
...
AO.qda.Monitor.ChannelNames = sirius_getname(AO.qda.FamilyName, 'Monitor', AO.qda.DeviceList);
...
AO.qda.Setpoint.ChannelNames  = sirius_getname(AO.qda.FamilyName, 'Setpoint', AO.qda.DeviceList);
...
AO.qf1.Monitor.ChannelNames = sirius_getname(AO.qf1.FamilyName, 'Monitor', AO.qf1.DeviceList);
...
AO.qf1.Setpoint.ChannelNames  = sirius_getname(AO.qf1.FamilyName, 'Setpoint', AO.qf1.DeviceList);
...
AO.qf2.Monitor.ChannelNames = sirius_getname(AO.qf2.FamilyName, 'Monitor', AO.qf2.DeviceList);
...
AO.qf2.Setpoint.ChannelNames  = sirius_getname(AO.qf2.FamilyName, 'Setpoint', AO.qf2.DeviceList);
...
AO.qf3.Monitor.ChannelNames = sirius_getname(AO.qf3.FamilyName, 'Monitor', AO.qf3.DeviceList);
...
AO.qf3.Setpoint.ChannelNames  = sirius_getname(AO.qf3.FamilyName, 'Setpoint', AO.qf3.DeviceList);
...
AO.qf4.Monitor.ChannelNames = sirius_getname(AO.qf4.FamilyName, 'Monitor', AO.qf4.DeviceList);
...
AO.qf4.Setpoint.ChannelNames = sirius_getname(AO.qf4.FamilyName, 'Setpoint', AO.qf4.DeviceList);
...
AO.sda.Monitor.ChannelNames = sirius_getname(AO.sda.FamilyName, 'Monitor', AO.sda.DeviceList);
...
AO.sda.Setpoint.ChannelNames = sirius_getname(AO.sda.FamilyName, 'Setpoint', AO.sda.DeviceList);
...
AO.sfa.Monitor.ChannelNames = sirius_getname(AO.sfa.FamilyName, 'Monitor', AO.sfa.DeviceList);
...
AO.sfa.Setpoint.ChannelNames = sirius_getname(AO.sfa.FamilyName, 'Setpoint', AO.sfa.DeviceList);
...
AO.sd1j.Monitor.ChannelNames = sirius_getname(AO.sd1j.FamilyName, 'Monitor', AO.sd1j.DeviceList);
...
AO.sd1j.Setpoint.ChannelNames = sirius_getname(AO.sd1j.FamilyName, 'Setpoint', AO.sd1j.DeviceList);
...
AO.sf1j.Monitor.ChannelNames = sirius_getname(AO.sf1j.FamilyName, 'Monitor', AO.sf1j.DeviceList);
...
AO.sf1j.Setpoint.ChannelNames = sirius_getname(AO.sf1j.FamilyName, 'Setpoint', AO.sf1j.DeviceList);
...
AO.sd2j.Monitor.ChannelNames = sirius_getname(AO.sd2j.FamilyName, 'Monitor', AO.sd2j.DeviceList);
...
AO.sd2j.Setpoint.ChannelNames = sirius_getname(AO.sd2j.FamilyName, 'Setpoint', AO.sd2j.DeviceList);
...
AO.sd3j.Monitor.ChannelNames = sirius_getname(AO.sd3j.FamilyName, 'Monitor', AO.sd3j.DeviceList);
...
AO.sd3j.Setpoint.ChannelNames = sirius_getname(AO.sd3j.FamilyName, 'Setpoint', AO.sd3j.DeviceList);
...
AO.sf2j.Monitor.ChannelNames = sirius_getname(AO.sf2j.FamilyName, 'Monitor', AO.sf2j.DeviceList);
...
AO.sf2j.Setpoint.ChannelNames = sirius_getname(AO.sf2j.FamilyName, 'Setpoint', AO.sf2j.DeviceList);
...
AO.sd1k.Monitor.ChannelNames = sirius_getname(AO.sd1k.FamilyName, 'Monitor', AO.sd1k.DeviceList);
...
AO.sd1k.Setpoint.ChannelNames = sirius_getname(AO.sd1k.FamilyName, 'Setpoint', AO.sd1k.DeviceList);
...
AO.sf1k.Monitor.ChannelNames = sirius_getname(AO.sf1k.FamilyName, 'Monitor', AO.sf1k.DeviceList);
...
AO.sf1k.Setpoint.ChannelNames = sirius_getname(AO.sf1k.FamilyName, 'Setpoint', AO.sf1k.DeviceList);
...
AO.sd2k.Monitor.ChannelNames = sirius_getname(AO.sd2k.FamilyName, 'Monitor', AO.sd2k.DeviceList);
...
AO.sd2k.Setpoint.ChannelNames = sirius_getname(AO.sd2k.FamilyName, 'Setpoint', AO.sd2k.DeviceList);
...
AO.sd3k.Monitor.ChannelNames = sirius_getname(AO.sd3k.FamilyName, 'Monitor', AO.sd3k.DeviceList);
...
AO.sd3k.Setpoint.ChannelNames = sirius_getname(AO.sd3k.FamilyName, 'Setpoint', AO.sd3k.DeviceList);
...
AO.sf2k.Monitor.ChannelNames = sirius_getname(AO.sf2k.FamilyName, 'Monitor', AO.sf2k.DeviceList);
...
AO.sf2k.Setpoint.ChannelNames = sirius_getname(AO.sf2k.FamilyName, 'Setpoint', AO.sf2k.DeviceList);
...
AO.sfb.Monitor.ChannelNames = sirius_getname(AO.sfb.FamilyName, 'Monitor', AO.sfb.DeviceList);
...
AO.sfb.Setpoint.ChannelNames = sirius_getname(AO.sfb.FamilyName, 'Setpoint', AO.sfb.DeviceList);
...
AO.sdb.Monitor.ChannelNames = sirius_getname(AO.sdb.FamilyName, 'Monitor', AO.sdb.DeviceList);
...
AO.sdb.Setpoint.ChannelNames = sirius_getname(AO.sdb.FamilyName, 'Setpoint', AO.sdb.DeviceList);
...
AO.chs.Monitor.ChannelNames = sirius_getname(AO.chs.FamilyName, 'Monitor', AO.chs.DeviceList);
...
AO.chs.Setpoint.ChannelNames = sirius_getname(AO.chs.FamilyName, 'Setpoint', AO.chs.DeviceList);
...
AO.cvs.Monitor.ChannelNames = sirius_getname(AO.cvs.FamilyName, 'Monitor', AO.cvs.DeviceList);
...
AO.cvs.Setpoint.ChannelNames = sirius_getname(AO.cvs.FamilyName, 'Setpoint', AO.cvs.DeviceList);
...
AO.chf.Monitor.ChannelNames  = sirius_getname(AO.chf.FamilyName, 'Monitor', AO.chf.DeviceList);
...
AO.chf.Setpoint.ChannelNames = sirius_getname(AO.chf.FamilyName, 'Setpoint', AO.chf.DeviceList);
...
AO.cvf.Monitor.ChannelNames  = sirius_getname(AO.cvf.FamilyName, 'Monitor', AO.cvf.DeviceList);
...
AO.cvf.Setpoint.ChannelNames  = sirius_getname(AO.cvf.FamilyName, 'Setpoint', AO.cvf.DeviceList);
...
AO.qs.Monitor.ChannelNames = sirius_getname(AO.qs.FamilyName, 'Monitor', AO.qs.DeviceList);
...
AO.qs.Setpoint.ChannelNames = sirius_getname(AO.qs.FamilyName, 'Setpoint', AO.qs.DeviceList);
...
AO.bpmx.Monitor.ChannelNames = sirius_getname(AO.bpmx.FamilyName, 'Monitor', AO.bpmx.DeviceList);
...
AO.bpmy.Monitor.ChannelNames = sirius_getname(AO.bpmy.FamilyName, 'Monitor', AO.bpmy.DeviceList);
