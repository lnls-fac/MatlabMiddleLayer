...
AO.qfa.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qfa.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qfa.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qfa.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qfa_shunt.MemberOf    = {'PlotFamily'; 'qfa_shunt'; 'QUAD'; 'Magnet';'q20';};
...
AO.qfa_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qfa_shunt.DeviceList,1),1)); 
AO.qfa_shunt.Monitor.MemberOf      = {};
AO.qfa_shunt.Monitor.Mode          = 'Simulator';
AO.qfa_shunt.Monitor.DataType      = 'Scalar';
AO.qfa_shunt.Monitor.ChannelNames  = sirius_getname(AO.qfa.FamilyName, 'Monitor', AO.qfa.DeviceList);
...
AO.qfa_shunt.Setpoint.ChannelNames = sirius_getname(AO.qfa.FamilyName, 'Setpoint', AO.qfa.DeviceList);
...
AO.qfa_fam.MemberOf    = {'PlotFamily'; 'qfa_fam'; 'QUAD'; 'Magnet'; 'q20';};
...
AO.qfa_fam.Position    = [];
AO.qfa_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qfa_fam.DeviceList,1),1)); 
AO.qfa_fam.Monitor.MemberOf      = {};
AO.qfa_fam.Monitor.Mode          = 'Simulator';
AO.qfa_fam.Monitor.DataType      = 'Vector';
AO.qfa_fam.Monitor.ChannelNames  = sirius_getname(AO.qfa_fam.FamilyName, 'Monitor');
...
AO.qfa_fam.Setpoint.DataType     = 'Vector';
AO.qfa_fam.Setpoint.ChannelNames = sirius_getname(AO.qfa_fam.FamilyName, 'Setpoint');
...
AO.qdb2.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qdb2.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qdb2.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qdb2.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qdb2_shunt.MemberOf    = {'PlotFamily'; 'qdb2_shunt'; 'QUAD'; 'Magnet';'q14';};
...
AO.qdb2_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q14',size(AO.qdb2_shunt.DeviceList,1),1)); 
AO.qdb2_shunt.Monitor.MemberOf      = {};
AO.qdb2_shunt.Monitor.Mode          = 'Simulator';
AO.qdb2_shunt.Monitor.DataType      = 'Scalar';
AO.qdb2_shunt.Monitor.ChannelNames  = sirius_getname(AO.qdb2.FamilyName, 'Monitor', AO.qdb2.DeviceList);
...
AO.qdb2_shunt.Setpoint.ChannelNames = sirius_getname(AO.qdb2.FamilyName, 'Setpoint', AO.qdb2.DeviceList);
...
AO.qdb2_fam.MemberOf    = {'PlotFamily'; 'qdb2_fam'; 'QUAD'; 'Magnet';'q14';};
...
AO.qdb2_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q14',size(AO.qdb2_fam.DeviceList,1),1)); 
AO.qdb2_fam.Monitor.MemberOf      = {};
AO.qdb2_fam.Monitor.Mode          = 'Simulator';
AO.qdb2_fam.Monitor.DataType      = 'Vector';
AO.qdb2_fam.Monitor.ChannelNames  = sirius_getname(AO.qdb2_fam.FamilyName, 'Monitor');
...
AO.qdb2_fam.Setpoint.DataType     = 'Vector';
AO.qdb2_fam.Setpoint.ChannelNames = sirius_getname(AO.qdb2_fam.FamilyName, 'Setpoint');
...
AO.qfb.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qfb.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qfb.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qfb.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qfb_shunt.MemberOf    = {'PlotFamily'; 'qfb_shunt'; 'QUAD'; 'Magnet';'q30';};
...
AO.qfb_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q30',size(AO.qfb_shunt.DeviceList,1),1)); 
AO.qfb_shunt.Monitor.MemberOf = {};
AO.qfb_shunt.Monitor.Mode = 'Simulator';
AO.qfb_shunt.Monitor.DataType = 'Scalar';
AO.qfb_shunt.Monitor.ChannelNames  = sirius_getname(AO.qfb.FamilyName, 'Monitor', AO.qfb.DeviceList);
...
AO.qfb_shunt.Setpoint.ChannelNames = sirius_getname(AO.qfb.FamilyName, 'Setpoint', AO.qfb.DeviceList);
...
AO.qfb_fam.MemberOf    = {'PlotFamily'; 'qfb_fam'; 'QUAD'; 'Magnet';'q30';};
...
AO.qfb_fam.Position    = [];
AO.qfb_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q30',size(AO.qfb_fam.DeviceList,1),1)); 
AO.qfb_fam.Monitor.MemberOf = {};
AO.qfb_fam.Monitor.Mode          = 'Simulator';
AO.qfb_fam.Monitor.DataType      = 'Vector';
AO.qfb_fam.Monitor.ChannelNames  = sirius_getname(AO.qfb_fam.FamilyName, 'Monitor');
...
AO.qfb_fam.Setpoint.DataType     = 'Vector';
AO.qfb_fam.Setpoint.ChannelNames = sirius_getname(AO.qfb_fam.FamilyName, 'Setpoint');
...
AO.qdb1.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qdb1.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qdb1.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qdb1.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qdb1_shunt.MemberOf    = {'PlotFamily'; 'qdb1_shunt'; 'QUAD'; 'Magnet';'q14';};
...
AO.qdb1_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q14',size(AO.qdb1_shunt.DeviceList,1),1)); 
AO.qdb1_shunt.Monitor.MemberOf       = {};
AO.qdb1_shunt.Monitor.Mode           = 'Simulator';
AO.qdb1_shunt.Monitor.DataType       = 'Scalar';
AO.qdb1_shunt.Monitor.ChannelNames   = sirius_getname(AO.qdb1.FamilyName, 'Monitor', AO.qdb1.DeviceList);
...
AO.qdb1_shunt.Setpoint.ChannelNames  = sirius_getname(AO.qdb1.FamilyName, 'Setpoint', AO.qdb1.DeviceList);
...
AO.qdb1_fam.MemberOf    = {'PlotFamily'; 'qdb1_fam'; 'QUAD'; 'Magnet';'q14';};
...
AO.qdb1_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q14',size(AO.qdb1_fam.DeviceList,1),1));
AO.qdb1_fam.Monitor.MemberOf = {};
AO.qdb1_fam.Monitor.Mode = 'Simulator';
AO.qdb1_fam.Monitor.DataType = 'Vector';
AO.qdb1_fam.Monitor.ChannelNames  = sirius_getname(AO.qdb1_fam.FamilyName, 'Monitor');
...
AO.qdb1_fam.Setpoint.DataType     = 'Vector';
AO.qdb1_fam.Setpoint.ChannelNames = sirius_getname(AO.qdb1_fam.FamilyName, 'Setpoint');
...
AO.qda.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qda.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qda.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qda.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qda_shunt.MemberOf    = {'PlotFamily'; 'qda_shunt'; 'QUAD'; 'Magnet';'q14';};
...
AO.qda_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q14',size(AO.qda_shunt.DeviceList,1),1));
AO.qda_shunt.Monitor.MemberOf = {};
AO.qda_shunt.Monitor.Mode = 'Simulator';
AO.qda_shunt.Monitor.DataType = 'Scalar';
AO.qda_shunt.Monitor.ChannelNames  = sirius_getname(AO.qda.FamilyName, 'Monitor', AO.qda.DeviceList);
...
AO.qda_shunt.Setpoint.ChannelNames = sirius_getname(AO.qda.FamilyName, 'Setpoint', AO.qda.DeviceList);
...
AO.qda_fam.MemberOf    = {'PlotFamily'; 'qda_fam'; 'QUAD'; 'Magnet';'q14';};
...
AO.qda_fam.Position    = [];
AO.qda_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q14',size(AO.qda_fam.DeviceList,1),1));
AO.qda_fam.Monitor.MemberOf = {};
AO.qda_fam.Monitor.Mode = 'Simulator';
AO.qda_fam.Monitor.DataType = 'Vector';
AO.qda_fam.Monitor.ChannelNames  = sirius_getname(AO.qda_fam.FamilyName, 'Monitor');
...
AO.qda_fam.Setpoint.DataType     = 'Vector';
AO.qda_fam.Setpoint.ChannelNames = sirius_getname(AO.qda_fam.FamilyName, 'Setpoint');
...
AO.qf1.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qf1.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qf1.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qf1.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qf1_shunt.MemberOf    = {'PlotFamily'; 'qf1_shunt'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf1_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf1_shunt.DeviceList,1),1));
AO.qf1_shunt.Monitor.MemberOf = {};
AO.qf1_shunt.Monitor.Mode = 'Simulator';
AO.qf1_shunt.Monitor.DataType = 'Scalar';
AO.qf1_shunt.Monitor.ChannelNames = sirius_getname(AO.qf1.FamilyName, 'Monitor', AO.qf1.DeviceList);
...
AO.qf1_shunt.Setpoint.ChannelNames  = sirius_getname(AO.qf1.FamilyName, 'Setpoint', AO.qf1.DeviceList);
...
AO.qf1_fam.MemberOf    = {'PlotFamily'; 'qf1_fam'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf1_fam.Position    = [];
AO.qf1_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf1_fam.DeviceList,1),1));
AO.qf1_fam.Monitor.MemberOf = {};
AO.qf1_fam.Monitor.Mode = 'Simulator';
AO.qf1_fam.Monitor.DataType = 'Vector';
AO.qf1_fam.Monitor.ChannelNames  = sirius_getname(AO.qf1_fam.FamilyName, 'Monitor');
...
AO.qf1_fam.Setpoint.DataType     = 'Vector';
AO.qf1_fam.Setpoint.ChannelNames = sirius_getname(AO.qf1_fam.FamilyName, 'Setpoint');
...
AO.qf2.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qf2.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qf2.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qf2.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qf2_shunt.MemberOf    = {'PlotFamily'; 'qf2_shunt'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf2_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf2_shunt.DeviceList,1),1));
AO.qf2_shunt.Monitor.MemberOf = {};
AO.qf2_shunt.Monitor.Mode = 'Simulator';
AO.qf2_shunt.Monitor.DataType = 'Scalar';
AO.qf2_shunt.Monitor.ChannelNames = sirius_getname(AO.qf2.FamilyName, 'Monitor', AO.qf2.DeviceList);
...
AO.qf2_shunt.Setpoint.ChannelNames  = sirius_getname(AO.qf2.FamilyName, 'Setpoint', AO.qf2.DeviceList);
...
AO.qf2_fam.MemberOf    = {'PlotFamily'; 'qf2_fam'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf2_fam.Position    = [];
AO.qf2_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf2_fam.DeviceList,1),1));
AO.qf2_fam.Monitor.MemberOf = {};
AO.qf2_fam.Monitor.Mode = 'Simulator';
AO.qf2_fam.Monitor.DataType = 'Vector';
AO.qf2_fam.Monitor.ChannelNames  = sirius_getname(AO.qf2_fam.FamilyName, 'Monitor');
...
AO.qf2_fam.Setpoint.DataType     = 'Vector';
AO.qf2_fam.Setpoint.ChannelNames = sirius_getname(AO.qf2_fam.FamilyName, 'Setpoint');
...
AO.qf3.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qf3.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qf3.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qf3.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qf3_shunt.MemberOf    = {'PlotFamily'; 'qf3_shunt'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf3_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf3_shunt.DeviceList,1),1));
AO.qf3_shunt.Monitor.MemberOf = {};
AO.qf3_shunt.Monitor.Mode = 'Simulator';
AO.qf3_shunt.Monitor.DataType = 'Scalar';
AO.qf3_shunt.Monitor.ChannelNames = sirius_getname(AO.qf3.FamilyName, 'Monitor', AO.qf3.DeviceList);
...
AO.qf3_shunt.Setpoint.ChannelNames  = sirius_getname(AO.qf3.FamilyName, 'Setpoint', AO.qf3.DeviceList);
...
AO.qf3_fam.MemberOf    = {'PlotFamily'; 'qf3_fam'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf3_fam.Position    = [];
AO.qf3_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf3_fam.DeviceList,1),1));
AO.qf3_fam.Monitor.MemberOf = {};
AO.qf3_fam.Monitor.Mode = 'Simulator';
AO.qf3_fam.Monitor.DataType = 'Vector';
AO.qf3_fam.Monitor.ChannelNames  = sirius_getname(AO.qf3_fam.FamilyName, 'Monitor');
...
AO.qf3_fam.Setpoint.DataType     = 'Vector';
AO.qf3_fam.Setpoint.ChannelNames = sirius_getname(AO.qf3_fam.FamilyName, 'Setpoint');
...
AO.qf4.Monitor.SpecialFunctionGet = @sirius_quadget;
AO.qf4.Monitor.SpecialFunctionSet = @sirius_quadset;
...
AO.qf4.Setpoint.SpecialFunctionGet = @sirius_quadget;
AO.qf4.Setpoint.SpecialFunctionSet = @sirius_quadset;
...
AO.qf4_shunt.MemberOf    = {'PlotFamily'; 'qf4_shunt'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf4_shunt.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf4_shunt.DeviceList,1),1));
AO.qf4_shunt.Monitor.MemberOf = {};
AO.qf4_shunt.Monitor.Mode = 'Simulator';
AO.qf4_shunt.Monitor.DataType = 'Scalar';
AO.qf4_shunt.Monitor.ChannelNames = sirius_getname(AO.qf4.FamilyName, 'Monitor', AO.qf4.DeviceList);
...
AO.qf4_shunt.Setpoint.ChannelNames = sirius_getname(AO.qf4.FamilyName, 'Setpoint', AO.qf4.DeviceList);
...
AO.qf4_fam.MemberOf    = {'PlotFamily'; 'qf4_fam'; 'QUAD'; 'Magnet';'q20';};
...
AO.qf4_fam.Position    = [];
AO.qf4_fam.ExcitationCurves = sirius_getexcdata(repmat('sima-q20',size(AO.qf4_fam.DeviceList,1),1));
AO.qf4_fam.Monitor.MemberOf = {};
AO.qf4_fam.Monitor.Mode = 'Simulator';
AO.qf4_fam.Monitor.DataType = 'Vector';
AO.qf4_fam.Monitor.ChannelNames  = sirius_getname(AO.qf4_fam.FamilyName, 'Monitor');
...
AO.qf4_fam.Setpoint.DataType     = 'Vector';
AO.qf4_fam.Setpoint.ChannelNames = sirius_getname(AO.qf4_fam.FamilyName, 'Setpoint');
...
AO.DCCT.Status                   = 1;
AO.DCCT.Position                 = [];
AO.DCCT.ChannelNames = ['SIDI-CURRENT';'SIDI-CURRENT']; 
...
AO.DCCT.Monitor.ChannelNames = ['SIDI-CURRENT';'SIDI-CURRENT']; 
