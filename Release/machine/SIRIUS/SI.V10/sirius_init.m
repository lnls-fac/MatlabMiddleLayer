...
AO.qfa_shunt.MemberOf    = {'PlotFamily'; 'qfa_shunt'; 'QUAD'; 'q20';};
...
AO.qfa_fam.MemberOf    = {'PlotFamily'; 'qfa_fam'; 'QUAD'; 'q20';};
...
AO.qdb2_shunt.MemberOf    = {'PlotFamily'; 'qdb2_shunt'; 'QUAD'; 'q14';};
...
AO.qdb2_fam.MemberOf    = {'PlotFamily'; 'qdb2_fam'; 'QUAD'; 'q14';};
...
AO.qfb_shunt.MemberOf    = {'PlotFamily'; 'qfb_shunt'; 'QUAD'; 'q30';};
...
AO.qfb_fam.MemberOf    = {'PlotFamily'; 'qfb_fam'; 'QUAD'; 'q30';};
...
AO.qdb1_shunt.MemberOf    = {'PlotFamily'; 'qdb1_shunt'; 'QUAD'; 'q14';};
...
AO.qdb1_fam.MemberOf    = {'PlotFamily'; 'qdb1_fam'; 'QUAD'; 'q14';};
...
AO.qda_shunt.MemberOf    = {'PlotFamily'; 'qda_shunt'; 'QUAD'; 'q14';};
...
AO.qda_fam.MemberOf    = {'PlotFamily'; 'qda_fam'; 'QUAD'; 'q14';};
...
AO.qf1_shunt.MemberOf    = {'PlotFamily'; 'qf1_shunt'; 'QUAD'; 'q20';};
...
AO.qf1_fam.MemberOf    = {'PlotFamily'; 'qf1_fam'; 'QUAD'; 'q20';};
...
AO.qf2_shunt.MemberOf    = {'PlotFamily'; 'qf2_shunt'; 'QUAD'; 'q20';};
...
AO.qf2_fam.MemberOf    = {'PlotFamily'; 'qf2_fam'; 'QUAD'; 'q20';};
...
AO.qf3_shunt.MemberOf    = {'PlotFamily'; 'qf3_shunt'; 'QUAD'; 'q20';};
...
AO.qf3_fam.MemberOf    = {'PlotFamily'; 'qf3_fam'; 'QUAD'; 'q20';};
...
AO.qf4_shunt.MemberOf    = {'PlotFamily'; 'qf4_shunt'; 'QUAD'; 'q20';};
...
AO.qf4_fam.MemberOf    = {'PlotFamily'; 'qf4_fam'; 'QUAD'; 'q20';};
...
AO.sda.Monitor.ChannelNames = sirius_si_getname(AO.sda.FamilyName, 'Monitor', AO.sda.DeviceList);
...
AO.sda.Setpoint.ChannelNames = sirius_si_getname(AO.sda.FamilyName, 'Setpoint', AO.sda.DeviceList);
...
AO.sfa.Monitor.ChannelNames = sirius_si_getname(AO.sfa.FamilyName, 'Monitor', AO.sfa.DeviceList);
...
AO.sfa.Setpoint.ChannelNames = sirius_si_getname(AO.sfa.FamilyName, 'Setpoint', AO.sfa.DeviceList);
...
AO.sd1j.Monitor.ChannelNames = sirius_si_getname(AO.sd1j.FamilyName, 'Monitor', AO.sd1j.DeviceList);
...
AO.sd1j.Setpoint.ChannelNames = sirius_si_getname(AO.sd1j.FamilyName, 'Setpoint', AO.sd1j.DeviceList);
...
AO.sf1j.Monitor.ChannelNames = sirius_si_getname(AO.sf1j.FamilyName, 'Monitor', AO.sf1j.DeviceList);
...
AO.sf1j.Setpoint.ChannelNames = sirius_si_getname(AO.sf1j.FamilyName, 'Setpoint', AO.sf1j.DeviceList);
...
AO.sd2j.Monitor.ChannelNames = sirius_si_getname(AO.sd2j.FamilyName, 'Monitor', AO.sd2j.DeviceList);
...
AO.sd2j.Setpoint.ChannelNames = sirius_si_getname(AO.sd2j.FamilyName, 'Setpoint', AO.sd2j.DeviceList);
...
AO.sd3j.Monitor.ChannelNames = sirius_si_getname(AO.sd3j.FamilyName, 'Monitor', AO.sd3j.DeviceList);
...
AO.sd3j.Setpoint.ChannelNames = sirius_si_getname(AO.sd3j.FamilyName, 'Setpoint', AO.sd3j.DeviceList);
...
AO.sf2j.Monitor.ChannelNames = sirius_si_getname(AO.sf2j.FamilyName, 'Monitor', AO.sf2j.DeviceList);
...
AO.sf2j.Setpoint.ChannelNames = sirius_si_getname(AO.sf2j.FamilyName, 'Setpoint', AO.sf2j.DeviceList);
...
AO.sd1k.Monitor.ChannelNames = sirius_si_getname(AO.sd1k.FamilyName, 'Monitor', AO.sd1k.DeviceList);
...
AO.sd1k.Setpoint.ChannelNames = sirius_si_getname(AO.sd1k.FamilyName, 'Setpoint', AO.sd1k.DeviceList);
...
AO.sf1k.Monitor.ChannelNames = sirius_si_getname(AO.sf1k.FamilyName, 'Monitor', AO.sf1k.DeviceList);
...
AO.sf1k.Setpoint.ChannelNames = sirius_si_getname(AO.sf1k.FamilyName, 'Setpoint', AO.sf1k.DeviceList);
...
AO.sd2k.Monitor.ChannelNames = sirius_si_getname(AO.sd2k.FamilyName, 'Monitor', AO.sd2k.DeviceList);
...
AO.sd2k.Setpoint.ChannelNames = sirius_si_getname(AO.sd2k.FamilyName, 'Setpoint', AO.sd2k.DeviceList);
...
AO.sd3k.Monitor.ChannelNames = sirius_si_getname(AO.sd3k.FamilyName, 'Monitor', AO.sd3k.DeviceList);
...
AO.sd3k.Setpoint.ChannelNames = sirius_si_getname(AO.sd3k.FamilyName, 'Setpoint', AO.sd3k.DeviceList);
...
AO.sf2k.Monitor.ChannelNames = sirius_si_getname(AO.sf2k.FamilyName, 'Monitor', AO.sf2k.DeviceList);
...
AO.sf2k.Setpoint.ChannelNames = sirius_si_getname(AO.sf2k.FamilyName, 'Setpoint', AO.sf2k.DeviceList);
...
AO.sfb.Monitor.ChannelNames = sirius_si_getname(AO.sfb.FamilyName, 'Monitor', AO.sfb.DeviceList);
...
AO.sfb.Setpoint.ChannelNames = sirius_si_getname(AO.sfb.FamilyName, 'Setpoint', AO.sfb.DeviceList);
...
AO.sdb.Monitor.ChannelNames = sirius_si_getname(AO.sdb.FamilyName, 'Monitor', AO.sdb.DeviceList);
...
AO.sdb.Setpoint.ChannelNames = sirius_si_getname(AO.sdb.FamilyName, 'Setpoint', AO.sdb.DeviceList);
