...
% %AO.bc_lf.Monitor.ChannelNames = sirius_si_getname(AO.bc_lf.FamilyName, 'Monitor', AO.bc_lf.DeviceList);
...
% %AO.bc_lf.Setpoint.ChannelNames = sirius_si_getname(AO.bc_lf.FamilyName, 'Setpoint', AO.bc_lf.DeviceList);
...
% %AO.bc_hf.Monitor.ChannelNames = sirius_si_getname(AO.bc_hf.FamilyName, 'Monitor', AO.bc_hf.DeviceList);
...
% %AO.bc_hf.Setpoint.ChannelNames = sirius_si_getname(AO.bc_hf.FamilyName, 'Setpoint', AO.bc_hf.DeviceList);
...
AO.chs.Position    = [];
AO.chs.ExcitationCurves = sirius_getexcdata(repmat('sima-ch',size(AO.chs.DeviceList,1),1));
AO.chs.Monitor.MemberOf = {'Horizontal'; 'COR'; 'chs'; 'Magnet';};
AO.chs.Monitor.Mode     = 'Simulator';
AO.chs.Monitor.DataType = 'Scalar';
AO.chs.Monitor.ChannelNames = sirius_si_getname(AO.chs.FamilyName, 'Monitor', AO.chs.DeviceList);
AO.chs.Monitor.Units        = 'Physics'; % ?
AO.chs.Monitor.HWUnits      = 'Ampere';
AO.chs.Monitor.PhysicsUnits = 'Radian';
AO.chs.Monitor.HW2PhysicsFcn  = @sirius_hw2ph;
AO.chs.Monitor.Physics2HWFcn  = @sirius_ph2hw;
...
AO.chs.Setpoint.ChannelNames = sirius_si_getname(AO.chs.FamilyName, 'Setpoint', AO.chs.DeviceList);
AO.chs.Setpoint.Units        = 'Physics';
AO.chs.Setpoint.HWUnits      = 'Ampere';
AO.chs.Setpoint.PhysicsUnits = 'Radian';
AO.chs.Setpoint.HW2PhysicsFcn  = @sirius_hw2ph;
...
AO.cvs.Position    = [];
AO.cvs.ExcitationCurves = sirius_getexcdata(repmat('sima-cv',size(AO.cvs.DeviceList,1),1));
AO.cvs.Monitor.MemberOf = {'Horizontal'; 'COR'; 'cvs'; 'Magnet';};
AO.cvs.Monitor.Mode     = 'Simulator';
AO.cvs.Monitor.DataType = 'Scalar';
AO.cvs.Monitor.ChannelNames = sirius_si_getname(AO.cvs.FamilyName, 'Monitor', AO.cvs.DeviceList);
AO.cvs.Monitor.Units        = 'Physics';
AO.cvs.Monitor.HWUnits      = 'Ampere';
AO.cvs.Monitor.PhysicsUnits = 'Radian';
AO.cvs.Monitor.HW2PhysicsFcn  = @sirius_hw2ph;
AO.cvs.Monitor.Physics2HWFcn  = @sirius_ph2hw;
...
AO.cvs.Setpoint.ChannelNames = sirius_si_getname(AO.cvs.FamilyName, 'Setpoint', AO.cvs.DeviceList);
AO.cvs.Setpoint.Units        = 'Physics';
AO.cvs.Setpoint.HWUnits      = 'Ampere';
AO.cvs.Setpoint.PhysicsUnits = 'Radian';
AO.cvs.Setpoint.HW2PhysicsFcn  = @sirius_hw2ph;
...
AO.chf.Position    = [];
AO.chf.ExcitationCurves = sirius_getexcdata(repmat('sima-ch',size(AO.chf.DeviceList,1),1));
AO.chf.Monitor.MemberOf = {'Horizontal'; 'COR'; 'chf'; 'Magnet';};
AO.chf.Monitor.Mode     = 'Simulator';
AO.chf.Monitor.DataType = 'Scalar';
AO.chf.Monitor.ChannelNames  = sirius_si_getname(AO.chf.FamilyName, 'Monitor', AO.chf.DeviceList);
AO.chf.Monitor.Units         = 'Physics';
AO.chf.Monitor.HWUnits       = 'Ampere';
AO.chf.Monitor.PhysicsUnits  = 'Radian';
AO.chf.Monitor.HW2PhysicsFcn  = @sirius_hw2ph;
AO.chf.Monitor.Physics2HWFcn  = @sirius_ph2hw;
...
AO.chf.Setpoint.ChannelNames = sirius_si_getname(AO.chf.FamilyName, 'Setpoint', AO.chf.DeviceList);
AO.chf.Setpoint.Units        = 'Physics';
AO.chf.Setpoint.HWUnits      = 'Ampere';
AO.chf.Setpoint.PhysicsUnits = 'Radian';
AO.chf.Setpoint.HW2PhysicsFcn  = @sirius_hw2ph;
...
AO.cvf.Position    = [];
AO.cvf.ExcitationCurves = sirius_getexcdata(repmat('sima-cv',size(AO.cvf.DeviceList,1),1));
AO.cvf.Monitor.MemberOf = {'Horizontal'; 'COR'; 'cvf'; 'Magnet';};
AO.cvf.Monitor.Mode     = 'Simulator';
AO.cvf.Monitor.DataType = 'Scalar';
AO.cvf.Monitor.ChannelNames  = sirius_si_getname(AO.cvf.FamilyName, 'Monitor', AO.cvf.DeviceList);
AO.cvf.Monitor.Units        = 'Physics';
AO.cvf.Monitor.HWUnits      = 'Ampere';
AO.cvf.Monitor.PhysicsUnits = 'Radian';
AO.cvf.Monitor.HW2PhysicsFcn  = @sirius_hw2ph;
AO.cvf.Monitor.Physics2HWFcn  = @sirius_ph2hw;
...
AO.cvf.Setpoint.ChannelNames  = sirius_si_getname(AO.cvf.FamilyName, 'Setpoint', AO.cvf.DeviceList);
AO.cvf.Setpoint.Units        = 'Physics';
AO.cvf.Setpoint.HWUnits      = 'Ampere';
AO.cvf.Setpoint.PhysicsUnits = 'Radian';
AO.cvf.Setpoint.HW2PhysicsFcn  = @sirius_hw2ph;
