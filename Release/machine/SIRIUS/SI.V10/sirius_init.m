...
AO.qfa_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qfa_fam.FamilyName, 'Monitor'), size(AO.qfa_fam.DeviceList,1),1);
...
AO.qfa_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qfa_fam.FamilyName, 'Setpoint'), size(AO.qfa_fam.DeviceList,1),1);
...
AO.qdb2_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qdb2_fam.FamilyName, 'Monitor'), size(AO.qdb2_fam.DeviceList,1),1) ;
...
AO.qdb2_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qdb2_fam.FamilyName, 'Setpoint'), size(AO.qdb2_fam.DeviceList,1),1);
...
AO.qfb_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qfb_fam.FamilyName, 'Monitor'), size(AO.qfb_fam.DeviceList,1),1); 
...
AO.qfb_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qfb_fam.FamilyName, 'Setpoint'), size(AO.qfb_fam.DeviceList,1),1);
...
AO.qdb1_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qdb1_fam.FamilyName, 'Monitor'), size(AO.qdb1_fam.DeviceList,1),1);
...
AO.qdb1_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qdb1_fam.FamilyName, 'Setpoint'), size(AO.qdb1_fam.DeviceList,1),1);
...
AO.qda_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qda_fam.FamilyName, 'Monitor'), size(AO.qda_fam.DeviceList,1),1);
...
AO.qda_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qda_fam.FamilyName, 'Setpoint'), size(AO.qda_fam.DeviceList,1),1);
...
AO.qf1_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qf1_fam.FamilyName, 'Monitor'), size(AO.qf1_fam.DeviceList,1),1);
...
AO.qf1_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qf1_fam.FamilyName, 'Setpoint'), size(AO.qf1_fam.DeviceList,1),1);
...
AO.qf2_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qf2_fam.FamilyName, 'Monitor'), size(AO.qf2_fam.DeviceList,1),1);
...
AO.qf2_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qf2_fam.FamilyName, 'Setpoint'), size(AO.qf2_fam.DeviceList,1),1);
...
AO.qf3_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qf3_fam.FamilyName, 'Monitor'), size(AO.qf3_fam.DeviceList,1),1);
...
AO.qf3_fam.Setpoint.ChannelNames = repmat( sirius_getname(AO.qf3_fam.FamilyName, 'Setpoint'), size(AO.qf3_fam.DeviceList,1),1);
...
AO.qf4_fam.Monitor.ChannelNames  = repmat(sirius_getname(AO.qf4_fam.FamilyName, 'Monitor'), size(AO.qf4_fam.DeviceList,1),1);
...
AO.qf4_fam.Setpoint.ChannelNames = repmat(sirius_getname(AO.qf4_fam.FamilyName, 'Setpoint'), size(AO.qf4_fam.DeviceList,1),1);
