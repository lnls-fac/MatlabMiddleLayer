...
AO.B.Position    = [];
AO.B.ExcitationCurves = sirius_getexcdata(repmat('tsma-b', size(AO.B.DeviceList,1), 1)); 
...
AO.EjeSF.Position    = [];
AO.EjeSF.ExcitationCurves = sirius_getexcdata(repmat('tspm-ejesf', size(AO.EjeSF.DeviceList,1), 1)); 
...
AO.EjeSG.Position    = [];
AO.EjeSG.ExcitationCurves = sirius_getexcdata(repmat('tspm-ejesg', size(AO.EjeSG.DeviceList,1), 1)); 
...
AO.InjSG.Position    = [];
AO.InjSG.ExcitationCurves = sirius_getexcdata(repmat('tspm-injsg', size(AO.InjSG.DeviceList,1), 1)); 
...
AO.InjSF.Position    = [];
AO.InjSF.ExcitationCurves = sirius_getexcdata(repmat('tspm-injsf', size(AO.InjSF.DeviceList,1), 1)); 
...
AO.QF1A.Position    = [];
AO.QF1A.ExcitationCurves = sirius_getexcdata(repmat('tsma-qf1a', size(AO.QF1A.DeviceList,1), 1));
...
AO.QF1B.Position    = [];
AO.QF1B.ExcitationCurves = sirius_getexcdata(repmat('tsma-qf1b', size(AO.QF1B.DeviceList,1), 1));
...
AO.QD2.Position    = [];
AO.QD2.ExcitationCurves = sirius_getexcdata(repmat('tsma-qd2', size(AO.QD2.DeviceList,1), 1));
...
AO.QF2.Position    = [];
AO.QF2.ExcitationCurves = sirius_getexcdata(repmat('tsma-qf2', size(AO.QF2.DeviceList,1), 1));
...
AO.QF3.Position    = [];
AO.QF3.ExcitationCurves = sirius_getexcdata(repmat('tsma-qf3', size(AO.QF3.DeviceList,1), 1));
...
AO.QD4A.Position    = [];
AO.QD4A.ExcitationCurves = sirius_getexcdata(repmat('tsma-qd4a', size(AO.QD4A.DeviceList,1), 1));
...
AO.QF4.Position    = [];
AO.QF4.ExcitationCurves = sirius_getexcdata(repmat('tsma-qf4', size(AO.QF4.DeviceList,1), 1));
...
AO.QD4B.Position    = [];
AO.QD4B.ExcitationCurves = sirius_getexcdata(repmat('tsma-qd4b', size(AO.QD4B.DeviceList,1), 1));
