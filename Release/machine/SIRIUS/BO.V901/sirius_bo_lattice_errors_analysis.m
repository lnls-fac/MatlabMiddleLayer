...
%% Magnet Errors:
    function machine = create_apply_errors(the_ring, family_data)
        ...
        config.fams.b1b2.labels       = {'b'};
        config.fams.b1b2.sigma_x      = 160 * um * 1;
        config.fams.b1b2.sigma_y      = 160 * um * 1;
        config.fams.b1b2.sigma_roll   = 0.800 * mrad * 1;
        config.fams.b1b2.sigma_e      = 0.15 * percent * 1;
        config.fams.b1b2.sigma_e_kdip = 2.4 * percent * 1;  % quadrupole errors due to pole variations
