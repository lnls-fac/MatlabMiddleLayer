...
AO.bf.FamilyName  = 'bf';
AO.bf.MemberOf    = {'PlotFamily'; 'bf'; 'BEND'; 'Magnet';};
AO.bf.DeviceList  = getDeviceList(1,2);
AO.bf.ElementList = (1:size(AO.bf.DeviceList,1))';
AO.bf.Status      = ones(size(AO.bf.DeviceList,1),1);
AO.bf.Position    = [];

AO.bf.Monitor.MemberOf = {};
AO.bf.Monitor.Mode = 'Simulator';
AO.bf.Monitor.DataType = 'Scalar';
AO.bf.Monitor.ChannelNames = getname(AO.bf.FamilyName, 'Monitor', AO.bf.DeviceList);
AO.bf.Monitor.HW2PhysicsParams = 1;
AO.bf.Monitor.Physics2HWParams = 1;
AO.bf.Monitor.Units        = 'Hardware';
AO.bf.Monitor.HWUnits      = 'Ampere';
AO.bf.Monitor.PhysicsUnits = 'GeV';

AO.bf.Setpoint.MemberOf = {'MachineConfig';};
AO.bf.Setpoint.Mode = 'Simulator';
AO.bf.Setpoint.DataType = 'Scalar';
AO.bf.Setpoint.ChannelNames = getname(AO.bf.FamilyName, 'Setpoint', AO.bf.DeviceList);
AO.bf.Setpoint.HW2PhysicsParams = 1;
AO.bf.Setpoint.Physics2HWParams = 1;
AO.bf.Setpoint.Units        = 'Hardware';
AO.bf.Setpoint.HWUnits      = 'Ampere';
AO.bf.Setpoint.PhysicsUnits = 'GeV';
AO.bf.Setpoint.Range        = [0 300];
AO.bf.Setpoint.Tolerance    = .1;
AO.bf.Setpoint.DeltaRespMat = .01;


AO.bd.FamilyName  = 'bd';
AO.bd.MemberOf    = {'PlotFamily'; 'bd'; 'BEND'; 'Magnet';};
AO.bd.DeviceList  = getDeviceList(1,2);
...
AO.bd.Monitor.ChannelNames = getname(AO.bd.FamilyName, 'Monitor', AO.bd.DeviceList);
AO.bd.Monitor.HW2PhysicsParams = 1;
AO.bd.Monitor.Physics2HWParams = 1;
AO.bd.Monitor.Units        = 'Hardware';
AO.bd.Monitor.HWUnits      = 'Ampere';
AO.bd.Monitor.PhysicsUnits = 'GeV';

AO.bd.Setpoint.MemberOf = {'MachineConfig';};
AO.bd.Setpoint.Mode = 'Simulator';
AO.bd.Setpoint.DataType = 'Scalar';
AO.bd.Setpoint.ChannelNames = getname(AO.bd.FamilyName, 'Setpoint', AO.bd.DeviceList);
AO.bd.Setpoint.HW2PhysicsParams = 1;
AO.bd.Setpoint.Physics2HWParams = 1;
AO.bd.Setpoint.Units        = 'Hardware';
AO.bd.Setpoint.HWUnits      = 'Ampere';
AO.bd.Setpoint.PhysicsUnits = 'GeV';
AO.bd.Setpoint.Range        = [0 300];
