...
AD = getad;
AD.Machine             = 'SIRIUS_V06';  % Will already be defined if setpathmml was used
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V06_A00';
AD.Energy              = 3.0;
...
AD = getad;
AD.Machine             = 'SIRIUS.V06';           % Will already be defined if setpathmml was used
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V06.C03';
AD.Energy              = 3.0;
AD.InjectionEnergy     = 3.0;
AD.ModeName            = 'C';
AD.ModeVersion         = '03';
