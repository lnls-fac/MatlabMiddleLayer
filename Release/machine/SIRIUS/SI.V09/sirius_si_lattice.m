...
% -- drifts --
LIA  = drift('lia2', 2.5479,'DriftPass');
LIB  = drift('lib2', 2.0429,'DriftPass');
...
L110 = drift('l110', 0.1100,'DriftPass');
...
L190 = drift('l190', 0.1900,'DriftPass');
...
M2A = [GIRDER,CF,L085,SFA,L150,QFA,L124,BPM,L116,QDA,L150,SDA,L190,GIRDER];                 % high beta xxM2 girder  
...
M1B = [GIRDER,L190,SDB,L150,QDB1,L116,BPM,L124,QFB,L260,SFB,L110,CF,L130,QDB2,GIRDER];      % low beta xxM1 girder
...
C1A = [GIRDER,L610,SD1,L170,QF1,L135, BPM,L125,SF1,L230,QF2,L170,SD2,L210,BPM,L130,GIRDER]; % arc sector in between B1-B2 (high beta odd-numbered straight sections)
C2A = [GIRDER,L460,SD3,L170,QF3,L083,CF,L077,SF2,L118,BPM,L112,QF4,L788,GIRDER];            % arc sector in between B2-B3 (high beta odd-numbered straight sections)
C4A = [GIRDER,L888,QF4,L112,BPM,L118,SF3,L077,CF,L083,QF3,L170,SD4,L330,BPM,L130,GIRDER];   % arc sector in between B3-B2 (high beta odd-numbered straight sections)
C5A = [GIRDER,L340,SD5,L170,QF2,L230,SF4,L125,BPM,L135,QF1,L170,SD6,L610,GIRDER];           % arc sector in between B2-B1 (high beta odd-numbered straight sections)
C1B = [GIRDER,L610,SD6,L170,QF1,L135, BPM,L125,SF4,L230,QF2,L170,SD5,L210,BPM,L130,GIRDER]; % arc sector in between B1-B2 (low beta even-numbered straight sections)
C2B = [GIRDER,L460,SD4,L170,QF3,L083,CF,L077,SF3,L118,BPM,L112,QF4,L788,GIRDER];            % arc sector in between B2-B3 (low beta even-numbered straight sections)
C4B = [GIRDER,L888,QF4,L112,BPM,L118,SF2,L077,CF,L083,QF3,L170,SD3,L330,BPM,L130,GIRDER];   % arc sector in between B3-B2 (low beta even-numbered straight sections)
C5B = [GIRDER,L340,SD2,L170,QF2,L230,SF1,L125,BPM,L135,QF1,L170,SD1,L610,GIRDER];           % arc sector in between B2-B1 (low beta even-numbered straight sections)
