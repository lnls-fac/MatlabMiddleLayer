...
InitialK1 = getcellstruct(THERING,'PolynomB',Q1I,1,2);
InitialK2 = getcellstruct(THERING,'PolynomB',Q2I,1,2);


% Compute initial tunes before fitting 
[~, InitialTunes] = linopt(THERING,0);
