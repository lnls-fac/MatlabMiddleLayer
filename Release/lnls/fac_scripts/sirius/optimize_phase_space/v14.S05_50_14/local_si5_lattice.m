...
C3A      = [L715,L112,QF4,L083,FC,L077,SF2K,L230,QF3,L170,SD3K,L275,L061];              % arc sector in between BC-B2 (high beta odd-numbered straight sections)
C3B      = [L715,L112,QF4,L083,FC,L077,SF2J,L230,QF3,L170,SD3J,L275,L061];              % arc sector in between BC-B2 (low beta even-numbered straight sections)
C4A      = [L216,SD2K,L170,QF2,L230,SF1K,L125,L135,QF1,L170,SD1K,L474];                 % arc sector in between B2-B1 (high beta odd-numbered straight sections)
C4B      = [L216,SD2J,L170,QF2,L230,SF1J,L125,L135,QF1,L170,SD1J,L474];                 % arc sector in between B2-B1 (low beta even-numbered straight sections)
...
SS_S07 = IDB; SS_S08 = IDB;
SS_S09 = IDA; SS_S10 = IDB;
SS_S11 = IDB; SS_S12 = IDB;
SS_S13 = IDA; SS_S14 = IDB;
SS_S15 = IDB; SS_S16 = IDB;
SS_S17 = IDA; SS_S18 = IDB;
SS_S19 = IDB; SS_S20 = IDB;
