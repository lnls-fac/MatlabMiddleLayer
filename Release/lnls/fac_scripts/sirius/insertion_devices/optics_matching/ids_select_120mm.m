function ids = ids_select_120mm(ids_names)
...
for i =1:length(ids_names)
    switch ids_names{i}
        ...
        case 'carnauba'
            ...
            ids{i}.kicktable_file  = [path2kcktbls, 'IVU19t/IVU19t_kicktable.txt'];
            ids{i}.nr_segs         = 20;
        ...
        case 'inga'
            ids{i}.label           = 'inga';
            ids{i}.kicktable_file  = [path2kcktbls, 'IVU25t/IVU25t_2ID_kicktable.txt'];
            ids{i}.nr_segs         = 40;
