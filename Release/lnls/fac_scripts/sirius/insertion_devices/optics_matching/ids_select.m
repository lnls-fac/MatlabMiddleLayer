...
%             ids{i}.straight_number = 4;
        case 'inga'
            ids{i}.label           = 'inga';
            ids{i}.kicktable_file  = '../id_modelling/U25/U25_2ID_kicktable.txt';
            ids{i}.nr_segs         = 40;
            ids{i}.straight_label  = 'mia';
            ids{i}.straight_number = 9;
        case 'ipe'
            ids{i}.label           = 'ipe';
            ids{i}.kicktable_file  = '../id_modelling/EPU80/EPU80_2ID_PH_kicktable.txt';
            ids{i}.nr_segs         = 40;
            ids{i}.straight_label  = 'mia';
...
%         case 'sabia'
%             ids{i}.label           = 'sabia';
%             ids{i}.kicktable_file  = '../id_modelling/EPU80/EPU80_2ID_PH_kicktable_6p5meters.txt';
%             ids{i}.nr_segs         = 40;
%             ids{i}.straight_label  = 'mia';
...
%         case 'sabia2'
%             ids{i}.label           = 'sabia2';
%             ids{i}.kicktable_file  = '../id_modelling/EPU80/EPU80_2ID_PV_kicktable.txt';
%             ids{i}.nr_segs         = 40;
%             ids{i}.straight_label  = 'mia';
%             ids{i}.straight_number = 8;
%         case 'sabia2'
