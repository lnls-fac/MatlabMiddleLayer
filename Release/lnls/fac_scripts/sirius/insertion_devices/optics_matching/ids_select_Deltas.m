function ids = ids_select_Deltas(ids_names)
...
for i =1:length(ids_names)
    switch ids_names{i}
        ...
        case 'carnauba'
            ...
            ids{i}.kicktable_file  = [path2kcktbls, 'DELTA20/Delta20_CP_kicktable.txt'];
            ids{i}.nr_segs         = 20;
        ...
        case 'ipe_hp'
            ids{i}.label           = 'ipe_hp';
            ids{i}.kicktable_file  = [path2kcktbls, 'DELTA50/Delta50_HP_kicktable.txt'];
            ids{i}.nr_segs         = 40;
            ids{i}.straight_label  = 'mip';
            ids{i}.straight_number = 11;
        case 'ipe_vp'
            ids{i}.label           = 'ipe_vp';
            ids{i}.kicktable_file  = [path2kcktbls, 'DELTA50/Delta50_VP_kicktable.txt'];
            ids{i}.nr_segs         = 40;
            ids{i}.straight_label  = 'mip';
            ids{i}.straight_number = 11;
        case 'ipe_cp'
            ids{i}.label           = 'ipe_cp';
            ids{i}.kicktable_file  = [path2kcktbls, 'DELTA50/Delta50_CP_kicktable.txt'];
            ids{i}.nr_segs         = 40;
            ids{i}.straight_label  = 'mip';
            ids{i}.straight_number = 11;
        case 'sabia_hp'
