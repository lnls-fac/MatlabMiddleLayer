function IDKickMap = create_kickmap_CATERETE
...
% parametros do ID
id_def.id_label = 'CATERETE';
id_def.nr_periods          = 111;
id_def.magnetic_gap        = 4.2 * mm;
id_def.period              = 18 * mm;
