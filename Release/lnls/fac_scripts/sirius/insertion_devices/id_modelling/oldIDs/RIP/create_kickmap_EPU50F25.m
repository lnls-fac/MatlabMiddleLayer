function IDKickMap = create_kickmap_EPU50F25
...
% parametros do ID
id_def.id_label = 'EPU50F25';
id_def.nr_periods          = 54;
id_def.magnetic_gap        = 11.5445 * mm;
id_def.period              = 50 * mm;
...
id_def.phase_csd           =  0*25 * mm;
id_def.phase_cie           =  0*25 * mm;
id_def.chamfer             =  0  * mm;
