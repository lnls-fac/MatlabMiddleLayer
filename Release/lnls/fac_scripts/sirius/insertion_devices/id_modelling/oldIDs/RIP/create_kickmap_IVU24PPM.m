function IDKickMap = create_kickmap_IVU24PPM
...
% parametros do ID
id_def.id_label = 'IVU24PPM';
id_def.nr_periods          = 117;
id_def.magnetic_gap        = 8.8057 * mm;
id_def.period              = 24 * mm;
...
id_def.block_width         = 35 * mm;
id_def.block_height        = 18 * mm;
