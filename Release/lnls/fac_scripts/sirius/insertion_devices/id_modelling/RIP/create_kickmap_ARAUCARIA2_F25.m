function IDKickMap = create_kickmap_ARAUCARIA2_F25
...
% parametros do ID
id_def.id_label = 'ARAUCARIA2_F25';
id_def.nr_periods          = 15;
id_def.magnetic_gap        = 10.0 * mm;
id_def.period              = 200 * mm;
...
id_def.phase_csd           =  +1.0 * (id_def.period/2);
id_def.phase_cie           =  +1.0 * (id_def.period/2);
id_def.chamfer             =  0  * mm;
id_def.magnetization       =  0.3558 * Tesla;
