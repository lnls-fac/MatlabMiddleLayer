function IDKickMap = create_kickmap_W2T
...
id_def.magnetic_gap        = 22 * mm;
id_def.period              = 180 * mm;
...
id_def.block_height        = 100 * mm;
id_def.phase_csd           =  0 * mm;
id_def.phase_cie           =  0 * mm;
id_def.chamfer             =  0  * mm;
id_def.magnetization       =  1.9497; % 5.5357 * Tesla; % 6.2104 * Tesla;
