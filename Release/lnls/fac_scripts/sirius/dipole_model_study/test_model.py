...
def test_field(rx, ry, rz):
    if rz > -500 and rz < 500:    
        return (0,-0.5,0)
    else:
        return (0,0,0)

ebeam      = beam.Beam(energy = 3)
fieldmap   = fieldmaptrack.FieldMap(field_function = test_field)
trajectory = track.Trajectory(beam = ebeam, fieldmap = fieldmap)
