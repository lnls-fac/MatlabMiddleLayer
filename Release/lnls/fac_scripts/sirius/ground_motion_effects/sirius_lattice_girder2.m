function r = sirius_lattice_girder2(varargin)
...
girderB1B2 = marker('girder_B1B2',  'IdentityPass');
...
%% transport lines
dispi  = [girderB1B2, b1, lcor, cv, lc11, ch, lcor, mon, lbpm, sd1, lc12, qf1, lq1, mon, lq2, sf1, lq, qf2, lc21, sd2, lcor, ch, lc22, b2, girderB1B2, ...
          girderBC, lcor, cv, lc31, mon, lbpm, sd3, lc32, qf3, lq1, lq2, sf2, lq, qf4, lcor, ch, lc4, ...
          b3, lb, mon, lbpm, bce ];
     
dispc  = [ bcs, lbpm, lb, b3, lc4, ch, lcor, qf4, lq, sf2, lq2, lq1, qf3, lc32, sd3, lbpm, mon, lc31, cv, lcor, girderBC, ...
           girderB1B2, b2, lc22, ch, lcor, sd2, lc21, qf2, lq, sf1, lq2, mon, lq1, qf1, lc12, sd1, lbpm, mon, lcor, ch, lc11, cv, lcor, b1, girderB1B2];
