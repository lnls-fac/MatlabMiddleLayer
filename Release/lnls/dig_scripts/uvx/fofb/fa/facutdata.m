...
selected_bpm_readings = [selected_bpm (nbpm+selected_bpm)];

data_cut = struct('time', data.time(pts), ...
               'bpm_readings', data.bpm_readings(pts, selected_bpm_readings), ...
               'bpm_names', {data.bpm_names(selected_bpm_readings)}, ...
