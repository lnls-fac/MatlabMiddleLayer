function z=rbend2(fname,L,A,A1,A2,K,gap,fint1,fint2,method)
...
% FINT1, FINT2 by X. Resende, LNLS, 2010.
...
ElemData.FringeInt1		= fint1; % 0.5: same convention as in Tracy II
ElemData.FringeInt2		= fint2; % 0.5: same convention as in Tracy II
