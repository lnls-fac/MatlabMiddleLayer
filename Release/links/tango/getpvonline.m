...
[AM, tout, DataTime, ErrorFlag] = readattribute(TangoNames, field, t - ExtraTimedelay, InputFlags{:});
...
if NAvg > 1
    ...
    for k = 2:NAvg,        
        ...
        [AM, tout, DataTime, ErrorFlag] = readattribute(TangoNames, field, tdelay, InputFlags{:});
