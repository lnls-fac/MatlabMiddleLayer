...
%  2011-04-27:  modified to get data from application PVServer strutuct (Ximenes)
...
function Data =  getpvlnls1(ChannelNames)
...
for i=1:length(modChannelNames)
    Data(i,1) = PVServer.state.(modChannelNames{i});
end
