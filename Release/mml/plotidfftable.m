...
legend(['HCM4, Sector ',num2str(IDFF.Sector-1),'  '], ...
       ['HCM1, Sector ',num2str(IDFF.Sector),  '  '],0);
...
legend(['VCM4, Sector ',num2str(IDFF.Sector-1),'  '], ...
       ['VCM1, Sector ',num2str(IDFF.Sector),  '  '],0);
...
if ExtraPlots == 1 
   ...
   axis tight;
   legend(['HCM4, Sector ',num2str(IDFF.Sector-1),'  '], ['HCM1, Sector ',num2str(IDFF.Sector),'  '],0);
   ...
   axis tight;
   legend(['VCM4, Sector ',num2str(IDFF.Sector-1),'  '], ['VCM1, Sector ',num2str(IDFF.Sector),'  '],0);
...
if 0
   ...
   legend(['HCM4, IDFF.Sector ',num2str(IDFF.Sector-1),'  '], ...
          ['HCM1, IDFF.Sector ',num2str(IDFF.Sector),  '  '],0);
